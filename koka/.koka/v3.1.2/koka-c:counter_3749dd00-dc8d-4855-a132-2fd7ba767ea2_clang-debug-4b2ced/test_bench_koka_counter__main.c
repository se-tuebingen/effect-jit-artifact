...
#include "test_bench_koka_counter__main.h"
...
void kk_test_bench_koka_counter__main__init(kk_context_t* _ctx){
  ...
  kk_test_bench_koka_counter__init(_ctx);
...
void kk_test_bench_koka_counter__main__done(kk_context_t* _ctx){
  ...
  _kk_done = true;
    ...
    KK_CUSTOM_DONE (_ctx);
  #endif
  kk_test_bench_koka_counter__done(_ctx);
...
static void _kk_main_exit(void) {
  ...
  kk_test_bench_koka_counter__main__done(_ctx);
}
...
int main(int argc, char** argv) {
  ...
  kk_test_bench_koka_counter__main__init(_ctx);
  atexit(&_kk_main_exit);
  kk_test_bench_koka_counter__main__main(_ctx);
  kk_test_bench_koka_counter__main__done(_ctx);
  kk_main_end(_ctx);
  return 0;
}
