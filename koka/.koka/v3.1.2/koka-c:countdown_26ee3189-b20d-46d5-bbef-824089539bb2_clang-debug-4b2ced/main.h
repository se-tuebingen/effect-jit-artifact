...
static inline kk_integer_t kk_main_state_fs__cfc(kk_main__state state, kk_context_t* _ctx) { /* forall<e,a> (state : state<e,a>) -> int */ 
  {
    struct kk_main__Hnd_state* _con_x123 = kk_main__as_Hnd_state(state, _ctx);
    kk_integer_t _x = _con_x123->_cfc;
...
static inline kk_std_core_hnd__clause0 kk_main_state_fs__fun_get(kk_main__state state, kk_context_t* _ctx) { /* forall<e,a> (state : state<e,a>) -> hnd/clause0<int,state,e,a> */ 
  {
    struct kk_main__Hnd_state* _con_x124 = kk_main__as_Hnd_state(state, _ctx);
    kk_std_core_hnd__clause0 _x = _con_x124->_fun_get;
...
static inline kk_std_core_hnd__clause1 kk_main_state_fs__fun_set(kk_main__state state, kk_context_t* _ctx) { /* forall<e,a> (state : state<e,a>) -> hnd/clause1<int,(),state,e,a> */ 
  {
    struct kk_main__Hnd_state* _con_x125 = kk_main__as_Hnd_state(state, _ctx);
    kk_std_core_hnd__clause1 _x = _con_x125->_fun_set;
...
static inline kk_std_core_hnd__clause0 kk_main__select_get(kk_main__state hnd, kk_context_t* _ctx) { /* forall<e,a> (hnd : state<e,a>) -> hnd/clause0<int,state,e,a> */ 
  {
    struct kk_main__Hnd_state* _con_x129 = kk_main__as_Hnd_state(hnd, _ctx);
    kk_std_core_hnd__clause0 _fun_get = _con_x129->_fun_get;
...
static inline kk_std_core_hnd__clause1 kk_main__select_set(kk_main__state hnd, kk_context_t* _ctx) { /* forall<e,a> (hnd : state<e,a>) -> hnd/clause1<int,(),state,e,a> */ 
  {
    struct kk_main__Hnd_state* _con_x130 = kk_main__as_Hnd_state(hnd, _ctx);
    kk_std_core_hnd__clause1 _fun_set = _con_x130->_fun_set;
...
static inline kk_function_t kk_main_new_get_fun133(kk_function_t _fun_unbox_x11, kk_context_t* _ctx) {
  struct kk_main_get_fun133__t* _self = kk_function_alloc_as(struct kk_main_get_fun133__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_main_get_fun133, kk_context());
...
static inline kk_integer_t kk_main_get(kk_context_t* _ctx) { /* () -> state int */ 
  kk_std_core_hnd__ev ev_10021 = kk_evv_at(((KK_IZ(0))),kk_context()); /*hnd/ev<main/state>*/;
  {
    struct kk_std_core_hnd_Ev* _con_x131 = kk_std_core_hnd__as_Ev(ev_10021, _ctx);
    kk_box_t _box_x8 = _con_x131->hnd;
    int32_t m = _con_x131->marker;
    kk_main__state h = kk_main__state_unbox(_box_x8, KK_BORROWED, _ctx);
    kk_main__state_dup(h, _ctx);
    {
      struct kk_main__Hnd_state* _con_x132 = kk_main__as_Hnd_state(h, _ctx);
      kk_integer_t _pat_0_0 = _con_x132->_cfc;
      kk_std_core_hnd__clause0 _fun_get = _con_x132->_fun_get;
      kk_std_core_hnd__clause1 _pat_1_0 = _con_x132->_fun_set;
      ...
      }
      {
        ...
        kk_function_t _bv_x17 = (kk_main_new_get_fun133(_fun_unbox_x11, _ctx)); /*(hnd/marker<3006,3008>, hnd/ev<3007>) -> 3005 3004*/;
        kk_box_t _x_x136 = kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_context_t*), _bv_x17, (_bv_x17, m, ev_10021, _ctx), _ctx); /*3004*/
        return kk_integer_unbox(_x_x136, _ctx);
      }
    }
  }
}
...
static inline kk_unit_t kk_main_set(kk_integer_t i, kk_context_t* _ctx) { /* (i : int) -> state () */ 
  kk_std_core_hnd__ev ev_10023 = kk_evv_at(((KK_IZ(0))),kk_context()); /*hnd/ev<main/state>*/;
  kk_box_t _x_x137;
  {
    struct kk_std_core_hnd_Ev* _con_x138 = kk_std_core_hnd__as_Ev(ev_10023, _ctx);
    kk_box_t _box_x25 = _con_x138->hnd;
    int32_t m = _con_x138->marker;
    kk_main__state h = kk_main__state_unbox(_box_x25, KK_BORROWED, _ctx);
    kk_main__state_dup(h, _ctx);
    {
      struct kk_main__Hnd_state* _con_x139 = kk_main__as_Hnd_state(h, _ctx);
      kk_integer_t _pat_0_0 = _con_x139->_cfc;
      kk_std_core_hnd__clause0 _pat_1_0 = _con_x139->_fun_get;
      kk_std_core_hnd__clause1 _fun_set = _con_x139->_fun_set;
      if kk_likely(kk_datatype_ptr_is_unique(h, _ctx)) {
      ...
      }
      {
        ...
        _x_x137 = kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x29, (_fun_unbox_x29, m, ev_10023, kk_integer_box(i, _ctx), _ctx), _ctx); /*1010*/
      }
    }
  }
  kk_unit_unbox(_x_x137); return kk_Unit;
}
