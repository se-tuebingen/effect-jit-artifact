...
class OutOfBounds_0 {
  ...
  __equals(other4505) {
    ...
    if (!($effekt.equals(this.__tag, other4505.__tag))) {
      return false;
    }
    return true;
  }
...
class None_0 {
  ...
  __equals(other4506) {
    ...
    if (!($effekt.equals(this.__tag, other4506.__tag))) {
      return false;
    }
    return true;
  }
...
class Some_0 {
  ...
  __equals(other4507) {
    ...
    if (!($effekt.equals(this.__tag, other4507.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.value_0, other4507.value_0))) {
      return false;
    }
    return true;
  }
...
class Nil_0 {
  ...
  __equals(other4508) {
    ...
    if (!($effekt.equals(this.__tag, other4508.__tag))) {
      return false;
    }
    return true;
  }
...
class Cons_0 {
  ...
  __equals(other4509) {
    ...
    if (!($effekt.equals(this.__tag, other4509.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.head_0, other4509.head_0))) {
      return false;
    }
    if (!($effekt.equals(this.tail_0, other4509.tail_0))) {
      return false;
    }
    return true;
  }
...
class Error_0 {
  ...
  __equals(other4510) {
    ...
    if (!($effekt.equals(this.__tag, other4510.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.exception_0, other4510.exception_0))) {
      return false;
    }
    if (!($effekt.equals(this.msg_0, other4510.msg_0))) {
      return false;
    }
    return true;
  }
...
class Success_0 {
  ...
  __equals(other4511) {
    ...
    if (!($effekt.equals(this.__tag, other4511.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.a_0, other4511.a_0))) {
      return false;
    }
    return true;
  }
...
function main_0(ks_16, k_16) {
  return RESET((p_0, ks_1, k_1) => {
    ...
    function range_worker_0(l_0, ks_18, k_15) {
      range_worker_1: while (true) {
        if ((l_0 > n_0)) {
          ...
          const tmp_l_0 = l_0;
          l_0 = (tmp_l_0 + (1));
          continue range_worker_1;
        }
      }
    }
    return range_worker_0(0, ks_17, (_0, ks_19) => {
      const x_1 = s_0.value;
      DEALLOC(s_0);
      const tmp_3 = $effekt.println(('' + x_1));
      return () => k_16(tmp_3, ks_19);
    });
  });
}
