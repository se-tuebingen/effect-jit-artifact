...
class OutOfBounds_0 {
  ...
  __equals(other4697) {
    ...
    if (!($effekt.equals(this.__tag, other4697.__tag))) {
      return false;
    }
    return true;
  }
...
class None_0 {
  ...
  __equals(other4698) {
    ...
    if (!($effekt.equals(this.__tag, other4698.__tag))) {
      return false;
    }
    return true;
  }
...
class Some_0 {
  ...
  __equals(other4699) {
    ...
    if (!($effekt.equals(this.__tag, other4699.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.value_0, other4699.value_0))) {
      return false;
    }
    return true;
  }
...
class Nil_0 {
  ...
  __equals(other4700) {
    ...
    if (!($effekt.equals(this.__tag, other4700.__tag))) {
      return false;
    }
    return true;
  }
...
class Cons_0 {
  ...
  __equals(other4701) {
    ...
    if (!($effekt.equals(this.head_0, other4701.head_0))) {
      return false;
    }
    if (!($effekt.equals(this.tail_0, other4701.tail_0))) {
      return false;
    }
    return true;
  }
...
class Error_0 {
  ...
  __equals(other4702) {
    ...
    if (!($effekt.equals(this.exception_0, other4702.exception_0))) {
      return false;
    }
    if (!($effekt.equals(this.msg_0, other4702.msg_0))) {
      return false;
    }
    return true;
  }
...
class Success_0 {
  ...
  __equals(other4703) {
    ...
    if (!($effekt.equals(this.a_0, other4703.a_0))) {
      return false;
    }
    return true;
  }
...
function run_0(n_0, ks_2, k_4) {
  const count_0 = global_0.fresh(0);
  const tmp_0 = (new Array(n_0));
  function loop_0(i_0, ks_1, k_1) {
    loop_1: while (true) {
      if ((i_0 < n_0)) {
        const tmp_1 = array$set(tmp_0, i_0, (0));
        /* prepare call */
        const tmp_i_0 = i_0;
        i_0 = (tmp_i_0 + (1));
        continue loop_1;
  ...
  return loop_0(0, ks_2, (v_r_1, ks_3) => {
    function permute_worker_0(n_1, ks_8, k_2) {
      permute_worker_1: while (true) {
        ...
        if (n_1 !== (0)) {
          ...
          const tmp_k_0 = k_2;
          k_2 = (v_r_2, ks_4) => {
            const i_1 = ks_4.arena.fresh((tmp_n_0 - (1)));
            function b_whileLoop_0(ks_5, k_3) {
              const x_1 = i_1.value;
              if ((x_1 >= (0))) {
                const x_2 = i_1.value;
                const tmp_3 = tmp_0[tmp_2];
                const tmp_4 = tmp_0[x_2];
                const tmp_5 = array$set(tmp_0, tmp_2, tmp_4);
                const tmp_6 = array$set(tmp_0, x_2, tmp_3);
                return permute_worker_0(tmp_2, ks_5, (v_r_3, ks_6) => {
                  const x_3 = i_1.value;
                  const tmp_7 = tmp_0[tmp_2];
                  const tmp_8 = tmp_0[x_3];
                  const tmp_9 = array$set(tmp_0, tmp_2, tmp_8);
                  const tmp_10 = array$set(tmp_0, x_3, tmp_7);
                  const x_4 = i_1.value;
                  i_1.value = (x_4 - (1));
                  return b_whileLoop_0(ks_6, k_3);
                });
              } else {
                return () => k_3($effekt.unit, ks_5);
              }
            }
            return b_whileLoop_0(ks_4, (tmp_11, ks_7) => {
              DEALLOC(i_1);
              return () => tmp_k_0(tmp_11, ks_7);
            });
          };
          n_1 = tmp_2;
          continue permute_worker_1;
        } else {
          return () => k_2($effekt.unit, ks_8);
        }
      }
    }
    return permute_worker_0(n_0, ks_3, (v_r_4, ks_9) => {
      const x_5 = count_0.value;
      return () => k_4(x_5, ks_9);
    });
  });
}

function main_0(ks_25, k_20) {
  return RESET((p_0, ks_10, k_5) => {
    const tmp_12 = process.argv.slice(1);
    const tmp_13 = tmp_12.length;
    function toList_worker_0(start_0, acc_0, ks_11, k_6) {
      toList_worker_1: while (true) {
        if ((start_0 < (1))) {
          return () => k_6(acc_0, ks_11);
        } else {
          const tmp_14 = tmp_12[start_0];
          /* prepare call */
          const tmp_start_0 = start_0;
          const tmp_acc_0 = acc_0;
          start_0 = (tmp_start_0 - (1));
          acc_0 = new Cons_0(tmp_14, tmp_acc_0);
          continue toList_worker_1;
        }
      }
    }
    return toList_worker_0((tmp_13 - (1)), new Nil_0(), ks_10, (v_r_5, ks_12) => {
      let v_r_6 = undefined;
      switch (v_r_5.__tag) {
      ...
      function go_0(index_1, acc_1, ks_17, k_11) {
        return RESET((p_1, ks_13, k_7) => {
          const Exception_1 = {
            raise_0: (exc_0, msg_1, ks_14, k_8) =>
              SHIFT(p_1, (k_9, ks_15, k_10) =>
                () => k_10(new Error_0(exc_0, msg_1), ks_15), ks_14, undefined)
          };
          return charAt_0(v_r_7, index_1, Exception_1, ks_13, (v_r_8, ks_16) =>
            () => k_7(new Success_0(v_r_8), ks_16));
        }, ks_17, (v_r_9, ks_18) => {
          switch (v_r_9.__tag) {
            case 1: 
              const v_y_2 = v_r_9.a_0;
              if ((v_y_2 >= (48))) if ((v_y_2 <= (57))) {
                return go_0((index_1 + (1)), ((((10) * acc_1)) + (((v_y_2) - ((48))))), ks_18, k_11);
              } else {
                return SHIFT(p_0, (k_12, ks_19, k_13) =>
                  () => k_13(10, ks_19), ks_18, undefined);
              } else {
                return SHIFT(p_0, (k_14, ks_20, k_15) =>
                  () => k_15(10, ks_20), ks_18, undefined);
              }
              break;
            case 0:  return () => k_11(acc_1, ks_18);
          }
        });
      }
      const Exception_2 = {
        raise_0: (exception_1, msg_2, ks_21, k_16) =>
          SHIFT(p_0, (k_17, ks_22, k_18) => () => k_18(10, ks_22), ks_21, undefined)
      };
      return charAt_0(v_r_7, 0, Exception_2, ks_12, (v_r_10, ks_23) => {
        if (v_r_10 === (45)) {
          ...
          return go_0(0, 0, ks_23, k_5);
        }
      });
    });
  }, ks_25, (n_2, ks_26) => {
    function loop_2(i_2, ks_27, k_19) {
      if ((i_2 < ((n_2 - (1))))) {
        return run_0(6, ks_27, (v_r_12, ks_28) =>
          loop_2((i_2 + (1)), ks_28, k_19));
      } else {
        return () => k_19($effekt.unit, ks_27);
      }
    }
    return loop_2(0, ks_26, (v_r_13, ks_29) =>
      run_0(6, ks_29, (r_0, ks_30) => {
        const tmp_15 = $effekt.println(('' + r_0));
        return () => k_20(tmp_15, ks_30);
      }));
  });
}

(typeof module != "undefined" && module !== null ? module : {}).exports = $permute = {
