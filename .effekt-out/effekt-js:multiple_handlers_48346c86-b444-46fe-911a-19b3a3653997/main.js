...
class OutOfBounds_0 {
  ...
  __equals(other4859) {
    ...
    if (!($effekt.equals(this.__tag, other4859.__tag))) {
      return false;
    }
    return true;
  }
...
class None_0 {
  ...
  __equals(other4860) {
    ...
    if (!($effekt.equals(this.__tag, other4860.__tag))) {
      return false;
    }
    return true;
  }
...
class Some_0 {
  ...
  __equals(other4861) {
    ...
    if (!($effekt.equals(this.__tag, other4861.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.value_0, other4861.value_0))) {
      return false;
    }
    return true;
  }
...
class Cons_0 {
  ...
  __equals(other4863) {
    ...
    if (!($effekt.equals(this.head_0, other4863.head_0))) {
      return false;
    }
    if (!($effekt.equals(this.tail_0, other4863.tail_0))) {
      return false;
    }
    return true;
  }
...
class Error_0 {
  ...
  __equals(other4864) {
    ...
    if (!($effekt.equals(this.exception_0, other4864.exception_0))) {
      return false;
    }
    if (!($effekt.equals(this.msg_0, other4864.msg_0))) {
      return false;
    }
    return true;
  }
...
class Success_0 {
  ...
  __equals(other4865) {
    ...
    if (!($effekt.equals(this.a_0, other4865.a_0))) {
      return false;
    }
    return true;
  }
...
function main_0(ks_16, k_18) {
  return RESET((p_0, ks_1, k_1) => {
    ...
    const res_0 = ks_17.arena.fresh(0);
    function go_1(i_0, ks_18, k_15) {
      go_2: while (true) {
        if ((i_0 > n_0)) {
          return () => k_15($effekt.unit, ks_18);
        } else {
          const x_0 = res_0.value;
          res_0.value = (((x_0 + ((i_0 * i_0)))) % (1009));
          /* prepare call */
          const tmp_i_0 = i_0;
          i_0 = (tmp_i_0 + (1));
          continue go_2;
    ...
    return go_1(0, ks_17, (_0, ks_19) => {
      const x_1 = res_0.value;
      DEALLOC(res_0);
      const res_1 = ks_19.arena.fresh(0);
      function go_3(i_1, ks_20, k_16) {
        go_4: while (true) {
          if ((i_1 > n_0)) {
            return () => k_16($effekt.unit, ks_20);
          } else {
            const x_2 = res_1.value;
            res_1.value = (((x_2 + i_1)) % (1009));
            /* prepare call */
            const tmp_i_1 = i_1;
            i_1 = (tmp_i_1 + (1));
            continue go_4;
      ...
      return go_3(0, ks_19, (_1, ks_21) => {
        const x_3 = res_1.value;
        DEALLOC(res_1);
        const res_2 = ks_21.arena.fresh(0);
        function go_5(i_2, ks_22, k_17) {
          go_6: while (true) {
            if ((i_2 > n_0)) {
              return () => k_17($effekt.unit, ks_22);
            } else {
              const x_4 = res_2.value;
              res_2.value = (((x_4 + (1))) % (1009));
              /* prepare call */
              const tmp_i_2 = i_2;
              i_2 = (tmp_i_2 + (1));
              continue go_6;
        ...
        return go_5(0, ks_21, (_2, ks_23) => {
          const x_5 = res_2.value;
          DEALLOC(res_2);
          const tmp_3 = $effekt.println(('' + ((((((x_1 * (1009))) + ((x_3 * (103))))) + x_5))));
          return () => k_18(tmp_3, ks_23);
        });
      });
    });
  });
