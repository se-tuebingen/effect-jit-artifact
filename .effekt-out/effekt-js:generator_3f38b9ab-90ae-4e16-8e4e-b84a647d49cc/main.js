...
class OutOfBounds_0 {
  ...
  __equals(other4787) {
    ...
    if (!($effekt.equals(this.__tag, other4787.__tag))) {
      return false;
    }
    return true;
  }
...
class None_0 {
  ...
  __equals(other4788) {
    ...
    if (!($effekt.equals(this.__tag, other4788.__tag))) {
      return false;
    }
    return true;
  }
...
class Some_0 {
  ...
  __equals(other4789) {
    ...
    if (!($effekt.equals(this.__tag, other4789.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.value_0, other4789.value_0))) {
      return false;
    }
    return true;
  }
...
class Nil_0 {
  ...
  __equals(other4790) {
    ...
    if (!($effekt.equals(this.__tag, other4790.__tag))) {
      return false;
    }
    return true;
  }
...
class Cons_0 {
  ...
  __equals(other4791) {
    ...
    if (!($effekt.equals(this.head_0, other4791.head_0))) {
      return false;
    }
    if (!($effekt.equals(this.tail_0, other4791.tail_0))) {
      return false;
    }
    return true;
  }
...
class Error_0 {
  ...
  __equals(other4792) {
    ...
    if (!($effekt.equals(this.exception_0, other4792.exception_0))) {
      return false;
    }
    if (!($effekt.equals(this.msg_0, other4792.msg_0))) {
      return false;
    }
    return true;
  }
...
class Success_0 {
  ...
  __equals(other4793) {
    ...
    if (!($effekt.equals(this.a_0, other4793.a_0))) {
      return false;
    }
    return true;
  }
...
class Node_0 {
  ...
  __equals(other4795) {
    ...
    if (!($effekt.equals(this.left_0, other4795.left_0))) {
      return false;
    }
    if (!($effekt.equals(this.value_1, other4795.value_1))) {
      return false;
    }
    if (!($effekt.equals(this.right_0, other4795.right_0))) {
      return false;
    }
    return true;
  }
...
function makeTree_0(n_0, ks_1, k_1) {
  makeTree_1: while (true) {
    if (n_0 === (0)) {
      return () => k_1(new Leaf_0(), ks_1);
    } else {
      /* prepare call */
      const tmp_n_0 = n_0;
      const tmp_k_0 = k_1;
      k_1 = (sub_0, ks_2) =>
        () => tmp_k_0(new Node_0(sub_0, tmp_n_0, sub_0), ks_2);
      n_0 = (tmp_n_0 - (1));
      continue makeTree_1;
    }
  }
...
function main_0(ks_18, k_24) {
  return RESET((p_0, ks_3, k_2) => {
    const tmp_0 = process.argv.slice(1);
    const tmp_1 = tmp_0.length;
    function toList_worker_0(start_0, acc_0, ks_4, k_3) {
      toList_worker_1: while (true) {
        if ((start_0 < (1))) {
          return () => k_3(acc_0, ks_4);
        } else {
    ...
    return toList_worker_0((tmp_1 - (1)), new Nil_0(), ks_3, (v_r_1, ks_5) => {
      let v_r_2 = undefined;
      switch (v_r_1.__tag) {
      ...
      function go_0(index_1, acc_1, ks_10, k_8) {
        return RESET((p_1, ks_6, k_4) => {
          const Exception_1 = {
            raise_0: (exc_0, msg_1, ks_7, k_5) =>
              SHIFT(p_1, (k_6, ks_8, k_7) =>
                () => k_7(new Error_0(exc_0, msg_1), ks_8), ks_7, undefined)
          };
          return charAt_0(v_r_3, index_1, Exception_1, ks_6, (v_r_4, ks_9) =>
            () => k_4(new Success_0(v_r_4), ks_9));
        }, ks_10, (v_r_5, ks_11) => {
          switch (v_r_5.__tag) {
            case 1: 
              const v_y_2 = v_r_5.a_0;
              if ((v_y_2 >= (48))) if ((v_y_2 <= (57))) {
                return go_0((index_1 + (1)), ((((10) * acc_1)) + (((v_y_2) - ((48))))), ks_11, k_8);
              } else {
                return SHIFT(p_0, (k_9, ks_12, k_10) =>
                  () => k_10(10, ks_12), ks_11, undefined);
              } else {
                return SHIFT(p_0, (k_11, ks_13, k_12) =>
                  () => k_12(10, ks_13), ks_11, undefined);
              }
              break;
            case 0:  return () => k_8(acc_1, ks_11);
          }
        });
      }
      const Exception_2 = {
        raise_0: (exception_1, msg_2, ks_14, k_13) =>
          SHIFT(p_0, (k_14, ks_15, k_15) => () => k_15(10, ks_15), ks_14, undefined)
      };
      return charAt_0(v_r_3, 0, Exception_2, ks_5, (v_r_6, ks_16) => {
        if (v_r_6 === (45)) {
          return go_0(1, 0, ks_16, (v_r_7, ks_17) =>
            () => k_2(((0) - v_r_7), ks_17));
        } else {
          return go_0(0, 0, ks_16, k_2);
        }
      });
    });
  }, ks_18, (n_1, ks_19) => {
    const r_0 = ks_19.arena.newRegion();
    return makeTree_0(n_1, ks_19, (tree_0, ks_20) => {
      const v_0 = r_0.fresh(new None_0());
      const cont_0 = r_0.fresh((ks_21, k_16) =>
        () => k_16($effekt.unit, ks_21));
      return RESET((p_2, ks_22, k_17) => {
        function iterate_worker_0(tree_1, ks_23, k_18) {
          iterate_worker_1: while (true) {
            switch (tree_1.__tag) {
              case 0:  return () => k_18($effekt.unit, ks_23);
              case 1: 
                const v_y_3 = tree_1.left_0;
                const v_y_4 = tree_1.value_1;
                const v_y_5 = tree_1.right_0;
                /* prepare call */
                const tmp_k_1 = k_18;
                k_18 = (_0, ks_24) =>
                  SHIFT(p_2, (k_19, ks_25, k_20) => {
                    v_0.value = new Some_0(v_y_4);
                    cont_0.value = (ks_26, k_21) =>
                      RESUME(k_19, (ks_27, k_22) =>
                        () => k_22($effekt.unit, ks_27), ks_26, k_21);
                    return () => k_20($effekt.unit, ks_25);
                  }, ks_24, (_1, ks_28) =>
                    iterate_worker_0(v_y_5, ks_28, tmp_k_1));
                tree_1 = v_y_3;
                continue iterate_worker_1;
            }
          }
        }
        return iterate_worker_0(tree_0, ks_22, (_2, ks_29) => {
          v_0.value = new None_0();
          return () => k_17($effekt.unit, ks_29);
        });
      }, ks_20, (_3, ks_30) => {
        function consumer_0(acc_2, ks_31, k_23) {
          const x_0 = v_0.value;
          switch (x_0.__tag) {
            case 0:  return () => k_23(acc_2, ks_31);
            case 1: 
              const v_y_6 = x_0.value_0;
              const x_1 = cont_0.value;
              const tmp_3 = x_1;
              return tmp_3(ks_31, (_4, ks_32) =>
                consumer_0((acc_2 + v_y_6), ks_32, k_23));
          }
        }
        return consumer_0(0, ks_30, (tmp_4, ks_33) => {
          DEALLOC(r_0);
          const tmp_5 = $effekt.println(('' + tmp_4));
          return () => k_24(tmp_5, ks_33);
        });
      });
    });
  });
