...
class OutOfBounds_0 {
  ...
  __equals(other4647) {
    ...
    if (!($effekt.equals(this.__tag, other4647.__tag))) {
      return false;
    }
    return true;
  }
...
class None_0 {
  ...
  __equals(other4648) {
    ...
    if (!($effekt.equals(this.__tag, other4648.__tag))) {
      return false;
    }
    return true;
  }
...
class Some_0 {
  ...
  __equals(other4649) {
    ...
    if (!($effekt.equals(this.__tag, other4649.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.value_0, other4649.value_0))) {
      return false;
    }
    return true;
  }
...
class Nil_0 {
  ...
  __equals(other4650) {
    ...
    if (!($effekt.equals(this.__tag, other4650.__tag))) {
      return false;
    }
    return true;
  }
...
class Cons_0 {
  ...
  __equals(other4651) {
    ...
    if (!($effekt.equals(this.__tag, other4651.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.head_0, other4651.head_0))) {
      return false;
    }
    if (!($effekt.equals(this.tail_0, other4651.tail_0))) {
      return false;
    }
    return true;
  }
...
class Error_0 {
  ...
  __equals(other4652) {
    ...
    if (!($effekt.equals(this.__tag, other4652.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.exception_0, other4652.exception_0))) {
      return false;
    }
    if (!($effekt.equals(this.msg_0, other4652.msg_0))) {
      return false;
    }
    return true;
  }
...
class Success_0 {
  ...
  __equals(other4653) {
    ...
    if (!($effekt.equals(this.__tag, other4653.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.a_0, other4653.a_0))) {
      return false;
    }
    return true;
  }
...
function length_0(xs_0, ks_1, k_1) {
  length_1: while (true) {
    switch (xs_0.__tag) {
      case 0:  return () => k_1(0, ks_1);
      case 1: 
        const v_y_0 = xs_0.tail_0;
        /* prepare call */
        const tmp_k_0 = k_1;
        k_1 = (v_r_1, ks_2) => () => tmp_k_0(((1) + v_r_1), ks_2);
        xs_0 = v_y_0;
        continue length_1;
    }
  }
...
function isShorterThan_0(x_0, y_0, ks_3, k_2) {
  isShorterThan_1: while (true) {
    switch (y_0.__tag) {
      case 0:  return () => k_2(false, ks_3);
      case 1: 
        const v_y_1 = y_0.tail_0;
        switch (x_0.__tag) {
          case 0:  return () => k_2(true, ks_3);
          case 1: 
            const v_y_2 = x_0.tail_0;
            /* prepare call */
            x_0 = v_y_2;
            y_0 = v_y_1;
            continue isShorterThan_1;
        }
        break;
      default:  return () => k_2(true, ks_3);
    }
  }
}

function makeList_0(n_0, ks_4, k_3) {
  makeList_1: while (true) {
    if (n_0 === (0)) {
      return () => k_3(new Nil_0(), ks_4);
    } else {
      /* prepare call */
      const tmp_n_0 = n_0;
      const tmp_k_1 = k_3;
      k_3 = (v_r_2, ks_5) =>
        () => tmp_k_1(new Cons_0(tmp_n_0, v_r_2), ks_5);
      n_0 = (tmp_n_0 - (1));
      continue makeList_1;
    }
  }
...
function tail_1(xs_1, ys_0, zs_0, ks_6, k_4) {
  return isShorterThan_0(ys_0, xs_1, ks_6, (v_r_3, ks_7) => {
    if (v_r_3) {
      switch (xs_1.__tag) {
        case 1: 
          const v_y_3 = xs_1.tail_0;
          switch (ys_0.__tag) {
            case 1: 
              const v_y_4 = ys_0.tail_0;
              switch (zs_0.__tag) {
                case 1: 
                  const v_y_5 = zs_0.tail_0;
                  return tail_1(v_y_3, ys_0, zs_0, ks_7, (v_r_4, ks_8) =>
                    tail_1(v_y_4, zs_0, xs_1, ks_8, (v_r_5, ks_9) =>
                      tail_1(v_y_5, xs_1, ys_0, ks_9, (v_r_6, ks_10) =>
                        tail_1(v_r_4, v_r_5, v_r_6, ks_10, k_4))));
                default: 
                  const tmp_0 = (function() { throw "oh no!" })();
                  return () => k_4(tmp_0, ks_7);
              }
              break;
            default: 
              const tmp_1 = (function() { throw "oh no!" })();
              return () => k_4(tmp_1, ks_7);
          }
          break;
        default: 
          const tmp_2 = (function() { throw "oh no!" })();
          return () => k_4(tmp_2, ks_7);
      }
    } else {
      return () => k_4(zs_0, ks_7);
    }
  });
}

function main_0(ks_26, k_20) {
  return RESET((p_0, ks_11, k_5) => {
    const tmp_3 = process.argv.slice(1);
    const tmp_4 = tmp_3.length;
    function toList_worker_0(start_0, acc_0, ks_12, k_6) {
      toList_worker_1: while (true) {
        if ((start_0 < (1))) {
          return () => k_6(acc_0, ks_12);
        } else {
          const tmp_5 = tmp_3[start_0];
          /* prepare call */
          const tmp_start_0 = start_0;
          const tmp_acc_0 = acc_0;
          start_0 = (tmp_start_0 - (1));
          acc_0 = new Cons_0(tmp_5, tmp_acc_0);
          continue toList_worker_1;
        }
      }
    }
    return toList_worker_0((tmp_4 - (1)), new Nil_0(), ks_11, (v_r_7, ks_13) => {
      let v_r_8 = undefined;
      switch (v_r_7.__tag) {
        case 0:  v_r_8 = new None_0();break;
        case 1: 
          const v_y_6 = v_r_7.head_0;
          v_r_8 = new Some_0(v_y_6);
          break;
      }
      let v_r_9 = undefined;
      switch (v_r_8.__tag) {
        case 0:  v_r_9 = "";break;
        case 1:  const v_y_7 = v_r_8.value_0;v_r_9 = v_y_7;break;
      }
      function go_0(index_1, acc_1, ks_18, k_11) {
        return RESET((p_1, ks_14, k_7) => {
          const Exception_1 = {
            raise_0: (exc_0, msg_1, ks_15, k_8) =>
              SHIFT(p_1, (k_9, ks_16, k_10) =>
                () => k_10(new Error_0(exc_0, msg_1), ks_16), ks_15, undefined)
          };
          return charAt_0(v_r_9, index_1, Exception_1, ks_14, (v_r_10, ks_17) =>
            () => k_7(new Success_0(v_r_10), ks_17));
        }, ks_18, (v_r_11, ks_19) => {
          switch (v_r_11.__tag) {
            case 1: 
              const v_y_8 = v_r_11.a_0;
              if ((v_y_8 >= (48))) if ((v_y_8 <= (57))) {
                return go_0((index_1 + (1)), ((((10) * acc_1)) + (((v_y_8) - ((48))))), ks_19, k_11);
              } else {
                return SHIFT(p_0, (k_12, ks_20, k_13) =>
                  () => k_13(10, ks_20), ks_19, undefined);
              } else {
                return SHIFT(p_0, (k_14, ks_21, k_15) =>
                  () => k_15(10, ks_21), ks_19, undefined);
              }
              break;
            case 0:  return () => k_11(acc_1, ks_19);
          }
        });
      }
      const Exception_2 = {
        raise_0: (exception_1, msg_2, ks_22, k_16) =>
          SHIFT(p_0, (k_17, ks_23, k_18) => () => k_18(10, ks_23), ks_22, undefined)
      };
      return charAt_0(v_r_9, 0, Exception_2, ks_13, (v_r_12, ks_24) => {
        if (v_r_12 === (45)) {
          return go_0(1, 0, ks_24, (v_r_13, ks_25) =>
            () => k_5(((0) - v_r_13), ks_25));
        } else {
          return go_0(0, 0, ks_24, k_5);
        }
      });
    });
  }, ks_26, (n_1, ks_27) => {
    function loop_0(i_0, ks_28, k_19) {
      if ((i_0 < ((n_1 - (1))))) {
        return makeList_0(15, ks_28, (v_r_14, ks_29) =>
          makeList_0(10, ks_29, (v_r_15, ks_30) =>
            makeList_0(6, ks_30, (v_r_16, ks_31) =>
              tail_1(v_r_14, v_r_15, v_r_16, ks_31, (v_r_17, ks_32) =>
                length_0(v_r_17, ks_32, (v_r_18, ks_33) =>
                  loop_0((i_0 + (1)), ks_33, k_19))))));
      } else {
        return () => k_19($effekt.unit, ks_28);
      }
    }
    return loop_0(0, ks_27, (v_r_19, ks_34) =>
      makeList_0(15, ks_34, (v_r_20, ks_35) =>
        makeList_0(10, ks_35, (v_r_21, ks_36) =>
          makeList_0(6, ks_36, (v_r_22, ks_37) =>
            tail_1(v_r_20, v_r_21, v_r_22, ks_37, (v_r_23, ks_38) =>
              length_0(v_r_23, ks_38, (r_0, ks_39) => {
                const tmp_6 = $effekt.println(('' + r_0));
                return () => k_20(tmp_6, ks_39);
              }))))));
  });
}

(typeof module != "undefined" && module !== null ? module : {}).exports = $list_tail = {
