...
class OutOfBounds_0 {
  ...
  __equals(other4526) {
    ...
    if (!($effekt.equals(this.__tag, other4526.__tag))) {
      return false;
    }
    return true;
  }
...
class None_0 {
  ...
  __equals(other4527) {
    ...
    if (!($effekt.equals(this.__tag, other4527.__tag))) {
      return false;
    }
    return true;
  }
...
class Some_0 {
  ...
  __equals(other4528) {
    ...
    if (!($effekt.equals(this.__tag, other4528.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.value_0, other4528.value_0))) {
      return false;
    }
    return true;
  }
...
class Nil_0 {
  ...
  __equals(other4529) {
    ...
    if (!($effekt.equals(this.__tag, other4529.__tag))) {
      return false;
    }
    return true;
  }
...
class Cons_0 {
  ...
  __equals(other4530) {
    ...
    if (!($effekt.equals(this.__tag, other4530.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.head_0, other4530.head_0))) {
      return false;
    }
    if (!($effekt.equals(this.tail_0, other4530.tail_0))) {
      return false;
    }
    return true;
  }
...
class Error_0 {
  ...
  __equals(other4531) {
    ...
    if (!($effekt.equals(this.__tag, other4531.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.exception_0, other4531.exception_0))) {
      return false;
    }
    if (!($effekt.equals(this.msg_0, other4531.msg_0))) {
      return false;
    }
    return true;
  }
...
class Success_0 {
  ...
  __equals(other4532) {
    ...
    if (!($effekt.equals(this.__tag, other4532.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.a_0, other4532.a_0))) {
      return false;
    }
    return true;
  }
...
function main_0(ks_16, k_16) {
  return RESET((p_0, ks_1, k_1) => {
    ...
    const s_0 = ks_17.arena.fresh(n_0);
    function countdown_worker_0(ks_18, k_15) {
      countdown_worker_1: while (true) {
        const x_0 = s_0.value;
        if (x_0 === (0)) {
          return () => k_15(x_0, ks_18);
        } else {
          s_0.value = (x_0 - (1));
          /* prepare call */
    ...
    return countdown_worker_0(ks_17, (tmp_3, ks_19) => {
      DEALLOC(s_0);
      const tmp_4 = $effekt.println(('' + tmp_3));
      return () => k_16(tmp_4, ks_19);
    });
  });
}
