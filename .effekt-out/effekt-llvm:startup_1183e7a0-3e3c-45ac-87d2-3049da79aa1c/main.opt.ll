; ModuleID = '/Users/gaisseml/dev/effect-jit/.effekt-out/effekt-llvm:startup_1183e7a0-3e3c-45ac-87d2-3049da79aa1c/main.ll'
source_filename = "/Users/gaisseml/dev/effect-jit/.effekt-out/effekt-llvm:startup_1183e7a0-3e3c-45ac-87d2-3049da79aa1c/main.ll"
...
@utf8StringLiteral_4513.lit = private constant [0 x i8] zeroinitializer
@utf8StringLiteral_4450.lit = private constant [21 x i8] c"Index out of bounds: "
@utf8StringLiteral_4452.lit = private constant [13 x i8] c" in string: '"
@utf8StringLiteral_4455.lit = private constant [1 x i8] c"'"
...
define tailcc void @returnAddress_1(%Pos %v_coe_3391_3455, ptr %stack) {
entry:
  %stackPointer_pointer.i = getelementptr i8, ptr %stack, i64 8
  %stackPointer.i = load ptr, ptr %stackPointer_pointer.i, align 8, !alias.scope !0
  ...
  tail call void @llvm.assume(i1 %isInside.i)
  %object.i = extractvalue %Pos %v_coe_3391_3455, 1
...
erasePositive.exit:                               ; preds = %entry, %decr.i.i, %free.i.i
  %z.i = tail call %Pos @c_bytearray_show_Int(i64 0)
  ...
  store ptr %newStackPointer.i, ptr %stackPointer_pointer.i, align 8, !alias.scope !0
  %returnAddress_2 = load ptr, ptr %newStackPointer.i, align 8, !noalias !0
  musttail call tailcc void %returnAddress_2(%Pos zeroinitializer, ptr nonnull %stack)
  ret void
}

define void @sharer_5(ptr %stackPointer) {
entry:
  %newStackPointer.i = getelementptr i8, ptr %stackPointer, i64 -24
...
define void @eraser_7(ptr %stackPointer) {
entry:
  %newStackPointer.i = getelementptr i8, ptr %stackPointer, i64 -24
  %stackEraser.i = getelementptr i8, ptr %stackPointer, i64 -8
  %eraser.i = load ptr, ptr %stackEraser.i, align 8
...
define tailcc void @returnAddress_14(%Pos %returned_4462, ptr nocapture %stack) {
entry:
  %stackMemory.i = getelementptr i8, ptr %stack, i64 8
  %stackPrompt.i = getelementptr i8, ptr %stack, i64 32
  %stackRest.i = getelementptr i8, ptr %stack, i64 40
...
underflowStack.exit:                              ; preds = %decrement.i.i, %free.i.i
  ...
  %newStackPointer.i = getelementptr i8, ptr %stackPointer.i, i64 -24
  store ptr %newStackPointer.i, ptr %stackPointer_pointer.i, align 8, !alias.scope !0
  %returnAddress_16 = load ptr, ptr %newStackPointer.i, align 8, !noalias !0
  musttail call tailcc void %returnAddress_16(%Pos %returned_4462, ptr %rest.i)
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define void @sharer_19(ptr nocapture readnone %stackPointer) #5 {
entry:
  ret void
}

; Function Attrs: mustprogress nounwind willreturn memory(argmem: readwrite, inaccessiblemem: readwrite)
define void @eraser_21(ptr nocapture %stackPointer) #10 {
entry:
  tail call void @free(ptr %stackPointer)
  ret void
}

define void @eraser_34(ptr nocapture readonly %environment) {
entry:
  %tmp_4412_32.elt1 = getelementptr inbounds i8, ptr %environment, i64 8
  %tmp_4412_32.unpack2 = load ptr, ptr %tmp_4412_32.elt1, align 8, !noalias !0
  %acc_3_3_5_169_4278_33.elt4 = getelementptr i8, ptr %environment, i64 24
  %acc_3_3_5_169_4278_33.unpack5 = load ptr, ptr %acc_3_3_5_169_4278_33.elt4, align 8, !noalias !0
  %isNull.i.i7 = icmp eq ptr %tmp_4412_32.unpack2, null
  br i1 %isNull.i.i7, label %erasePositive.exit17, label %next.i.i8

next.i.i8:                                        ; preds = %entry
  %referenceCount.i.i9 = load i64, ptr %tmp_4412_32.unpack2, align 4
...
decr.i.i11:                                       ; preds = %next.i.i8
  ...
  store i64 %referenceCount.1.i.i12, ptr %tmp_4412_32.unpack2, align 4
  br label %erasePositive.exit17

free.i.i13:                                       ; preds = %next.i.i8
  %objectEraser.i.i14 = getelementptr i8, ptr %tmp_4412_32.unpack2, i64 8
  %eraser.i.i15 = load ptr, ptr %objectEraser.i.i14, align 8
  %environment.i.i.i16 = getelementptr i8, ptr %tmp_4412_32.unpack2, i64 16
  tail call void %eraser.i.i15(ptr %environment.i.i.i16)
  tail call void @free(ptr nonnull %tmp_4412_32.unpack2)
  br label %erasePositive.exit17

erasePositive.exit17:                             ; preds = %entry, %decr.i.i11, %free.i.i13
  %isNull.i.i = icmp eq ptr %acc_3_3_5_169_4278_33.unpack5, null
  br i1 %isNull.i.i, label %erasePositive.exit, label %next.i.i

next.i.i:                                         ; preds = %erasePositive.exit17
  %referenceCount.i.i = load i64, ptr %acc_3_3_5_169_4278_33.unpack5, align 4
  %cond.i.i = icmp eq i64 %referenceCount.i.i, 0
  br i1 %cond.i.i, label %free.i.i, label %decr.i.i

decr.i.i:                                         ; preds = %next.i.i
  %referenceCount.1.i.i = add i64 %referenceCount.i.i, -1
  store i64 %referenceCount.1.i.i, ptr %acc_3_3_5_169_4278_33.unpack5, align 4
  br label %erasePositive.exit

free.i.i:                                         ; preds = %next.i.i
  %objectEraser.i.i = getelementptr i8, ptr %acc_3_3_5_169_4278_33.unpack5, i64 8
  %eraser.i.i = load ptr, ptr %objectEraser.i.i, align 8
  %environment.i.i.i = getelementptr i8, ptr %acc_3_3_5_169_4278_33.unpack5, i64 16
  tail call void %eraser.i.i(ptr %environment.i.i.i)
  tail call void @free(ptr nonnull %acc_3_3_5_169_4278_33.unpack5)
  br label %erasePositive.exit
...
define tailcc void @toList_1_1_3_167_4088(i64 %start_2_2_4_168_4096, %Pos %acc_3_3_5_169_4278, ptr %stack) local_unnamed_addr {
entry:
  %z.i6 = icmp slt i64 %start_2_2_4_168_4096, 1
  br i1 %z.i6, label %label_44, label %label_40

label_40:                                         ; preds = %entry, %label_40
  %acc_3_3_5_169_4278.tr8 = phi %Pos [ %make_4468, %label_40 ], [ %acc_3_3_5_169_4278, %entry ]
  %start_2_2_4_168_4096.tr7 = phi i64 [ %z.i5, %label_40 ], [ %start_2_2_4_168_4096, %entry ]
  %s.i = tail call %Pos @c_get_arg(i64 %start_2_2_4_168_4096.tr7)
  %z.i5 = add nsw i64 %start_2_2_4_168_4096.tr7, -1
  ...
  store ptr @eraser_34, ptr %objectEraser.i, align 8
  %environment.i = getelementptr i8, ptr %object.i, i64 16
  %pureApp_4465.elt = extractvalue %Pos %s.i, 0
  store i64 %pureApp_4465.elt, ptr %environment.i, align 8, !noalias !0
  %environment_31.repack1 = getelementptr i8, ptr %object.i, i64 24
  %pureApp_4465.elt2 = extractvalue %Pos %s.i, 1
  store ptr %pureApp_4465.elt2, ptr %environment_31.repack1, align 8, !noalias !0
  %acc_3_3_5_169_4278_pointer_38 = getelementptr i8, ptr %object.i, i64 32
  %acc_3_3_5_169_4278.elt = extractvalue %Pos %acc_3_3_5_169_4278.tr8, 0
  store i64 %acc_3_3_5_169_4278.elt, ptr %acc_3_3_5_169_4278_pointer_38, align 8, !noalias !0
  %acc_3_3_5_169_4278_pointer_38.repack3 = getelementptr i8, ptr %object.i, i64 40
  %acc_3_3_5_169_4278.elt4 = extractvalue %Pos %acc_3_3_5_169_4278.tr8, 1
  store ptr %acc_3_3_5_169_4278.elt4, ptr %acc_3_3_5_169_4278_pointer_38.repack3, align 8, !noalias !0
  %make_4468 = insertvalue %Pos { i64 1, ptr null }, ptr %object.i, 1
  %z.i = icmp ult i64 %start_2_2_4_168_4096.tr7, 2
  br i1 %z.i, label %label_44, label %label_40

label_44:                                         ; preds = %label_40, %entry
  %acc_3_3_5_169_4278.tr.lcssa = phi %Pos [ %acc_3_3_5_169_4278, %entry ], [ %make_4468, %label_40 ]
  %stackPointer_pointer.i = getelementptr i8, ptr %stack, i64 8
  %stackPointer.i = load ptr, ptr %stackPointer_pointer.i, align 8, !alias.scope !0
  %limit_pointer.i = getelementptr i8, ptr %stack, i64 24
  %limit.i = load ptr, ptr %limit_pointer.i, align 8, !alias.scope !0
  ...
  musttail call tailcc void %returnAddress_41(%Pos %acc_3_3_5_169_4278.tr.lcssa, ptr %stack)
  ret void
}

define tailcc void @returnAddress_55(%Pos %v_r_2548_32_59_223_4259, ptr %stack) {
entry:
  %stackPointer_pointer.i = getelementptr i8, ptr %stack, i64 8
  %stackPointer.i = load ptr, ptr %stackPointer_pointer.i, align 8, !alias.scope !0
  %oldStackPointer.i = getelementptr i8, ptr %stackPointer.i, i64 24
  ...
  store ptr %newStackPointer.i, ptr %stackPointer_pointer.i, align 8, !alias.scope !0
  %acc_8_35_199_4210 = load i64, ptr %newStackPointer.i, align 4, !noalias !0
  %tmp_4419_pointer_58 = getelementptr i8, ptr %stackPointer.i, i64 -40
  %tmp_4419 = load i64, ptr %tmp_4419_pointer_58, align 4, !noalias !0
  %v_r_2464_30_194_4172_pointer_59 = getelementptr i8, ptr %stackPointer.i, i64 -32
  %v_r_2464_30_194_4172.unpack = load i64, ptr %v_r_2464_30_194_4172_pointer_59, align 8, !noalias !0
  %v_r_2464_30_194_4172.elt1 = getelementptr i8, ptr %stackPointer.i, i64 -24
  %v_r_2464_30_194_4172.unpack2 = load ptr, ptr %v_r_2464_30_194_4172.elt1, align 8, !noalias !0
  %p_8_9_3988_pointer_60 = getelementptr i8, ptr %stackPointer.i, i64 -16
  %p_8_9_3988 = load ptr, ptr %p_8_9_3988_pointer_60, align 8, !noalias !0
  %index_7_34_198_4062_pointer_61 = getelementptr i8, ptr %stackPointer.i, i64 -8
  %index_7_34_198_4062 = load i64, ptr %index_7_34_198_4062_pointer_61, align 4, !noalias !0
  %tag_62 = extractvalue %Pos %v_r_2548_32_59_223_4259, 0
  %fields_63 = extractvalue %Pos %v_r_2548_32_59_223_4259, 1
  switch i64 %tag_62, label %common.ret [
    i64 1, label %label_87
...
label_75:                                         ; preds = %eraseObject.exit19
  %isNull.i.i35 = icmp eq ptr %v_r_2464_30_194_4172.unpack2, null
  br i1 %isNull.i.i35, label %erasePositive.exit45, label %next.i.i36

next.i.i36:                                       ; preds = %label_75
  %referenceCount.i.i37 = load i64, ptr %v_r_2464_30_194_4172.unpack2, align 4
...
decr.i.i39:                                       ; preds = %next.i.i36
  ...
  store i64 %referenceCount.1.i.i40, ptr %v_r_2464_30_194_4172.unpack2, align 4
  br label %erasePositive.exit45

free.i.i41:                                       ; preds = %next.i.i36
  %objectEraser.i.i42 = getelementptr i8, ptr %v_r_2464_30_194_4172.unpack2, i64 8
  %eraser.i.i43 = load ptr, ptr %objectEraser.i.i42, align 8
  %environment.i.i.i44 = getelementptr i8, ptr %v_r_2464_30_194_4172.unpack2, i64 16
  tail call void %eraser.i.i43(ptr %environment.i.i.i44)
  tail call void @free(ptr nonnull %v_r_2464_30_194_4172.unpack2)
  br label %erasePositive.exit45

erasePositive.exit45:                             ; preds = %label_75, %decr.i.i39, %free.i.i41
  %pair_70 = tail call <{ ptr, ptr }> @shift(ptr nonnull %stack, ptr %p_8_9_3988)
  %k_13_14_4_4357 = extractvalue <{ ptr, ptr }> %pair_70, 0
  %referenceCount.i51 = load i64, ptr %k_13_14_4_4357, align 4
...
decr.i53:                                         ; preds = %erasePositive.exit45
  ...
  store i64 %referenceCount.1.i54, ptr %k_13_14_4_4357, align 4
  br label %eraseResumption.exit58

free.i55:                                         ; preds = %erasePositive.exit45
  %stack_pointer.i56 = getelementptr i8, ptr %k_13_14_4_4357, i64 40
...
eraseResumption.exit58:                           ; preds = %erasePrompt.exit.i, %decr.i53
  %stack_71 = extractvalue <{ ptr, ptr }> %pair_70, 1
  %stackPointer_pointer.i72 = getelementptr i8, ptr %stack_71, i64 8
  %stackPointer.i73 = load ptr, ptr %stackPointer_pointer.i72, align 8, !alias.scope !0
  %limit_pointer.i74 = getelementptr i8, ptr %stack_71, i64 24
  ...
  %returnAddress_72 = load ptr, ptr %newStackPointer.i77, align 8, !noalias !0
  musttail call tailcc void %returnAddress_72(%Pos { i64 5, ptr null }, ptr %stack_71)
  ret void

label_84:                                         ; preds = %label_86
  %isNull.i.i24 = icmp eq ptr %v_r_2464_30_194_4172.unpack2, null
  br i1 %isNull.i.i24, label %erasePositive.exit34, label %next.i.i25

next.i.i25:                                       ; preds = %label_84
  %referenceCount.i.i26 = load i64, ptr %v_r_2464_30_194_4172.unpack2, align 4
...
decr.i.i28:                                       ; preds = %next.i.i25
  ...
  store i64 %referenceCount.1.i.i29, ptr %v_r_2464_30_194_4172.unpack2, align 4
  br label %erasePositive.exit34

free.i.i30:                                       ; preds = %next.i.i25
  %objectEraser.i.i31 = getelementptr i8, ptr %v_r_2464_30_194_4172.unpack2, i64 8
  %eraser.i.i32 = load ptr, ptr %objectEraser.i.i31, align 8
  %environment.i.i.i33 = getelementptr i8, ptr %v_r_2464_30_194_4172.unpack2, i64 16
  tail call void %eraser.i.i32(ptr %environment.i.i.i33)
  tail call void @free(ptr nonnull %v_r_2464_30_194_4172.unpack2)
  br label %erasePositive.exit34

erasePositive.exit34:                             ; preds = %label_84, %decr.i.i28, %free.i.i30
  %pair_79 = tail call <{ ptr, ptr }> @shift(ptr nonnull %stack, ptr %p_8_9_3988)
  %k_13_14_4_4356 = extractvalue <{ ptr, ptr }> %pair_79, 0
  %referenceCount.i46 = load i64, ptr %k_13_14_4_4356, align 4
...
decr.i48:                                         ; preds = %erasePositive.exit34
  ...
  store i64 %referenceCount.1.i49, ptr %k_13_14_4_4356, align 4
  br label %eraseResumption.exit

free.i50:                                         ; preds = %erasePositive.exit34
  %stack_pointer.i = getelementptr i8, ptr %k_13_14_4_4356, i64 40
...
eraseResumption.exit:                             ; preds = %erasePrompt.exit.i97, %decr.i48
  %stack_80 = extractvalue <{ ptr, ptr }> %pair_79, 1
  %stackPointer_pointer.i102 = getelementptr i8, ptr %stack_80, i64 8
  %stackPointer.i103 = load ptr, ptr %stackPointer_pointer.i102, align 8, !alias.scope !0
  %limit_pointer.i104 = getelementptr i8, ptr %stack_80, i64 24
  ...
  %returnAddress_81 = load ptr, ptr %newStackPointer.i107, align 8, !noalias !0
  musttail call tailcc void %returnAddress_81(%Pos { i64 5, ptr null }, ptr %stack_80)
  ret void

label_85:                                         ; preds = %label_86
  %0 = insertvalue %Pos poison, i64 %v_r_2464_30_194_4172.unpack, 0
  %v_r_2464_30_194_41723 = insertvalue %Pos %0, ptr %v_r_2464_30_194_4172.unpack2, 1
  %z.i = add i64 %index_7_34_198_4062, 1
  %z.i108 = mul i64 %acc_8_35_199_4210, 10
  %z.i109 = sub i64 %z.i108, %tmp_4419
  %z.i110 = add i64 %z.i109, %v_coe_3366_46_73_237_4169.unpack
  musttail call tailcc void @go_6_33_197_4123(i64 %z.i, i64 %z.i110, i64 %tmp_4419, %Pos %v_r_2464_30_194_41723, ptr %p_8_9_3988, ptr nonnull %stack)
  ret void

label_86:                                         ; preds = %eraseObject.exit19
  %z.i111 = icmp ult i64 %v_coe_3366_46_73_237_4169.unpack, 58
  br i1 %z.i111, label %label_85, label %label_84

label_87:                                         ; preds = %entry
  %environment.i8 = getelementptr i8, ptr %fields_63, i64 16
  %v_coe_3366_46_73_237_4169.unpack = load i64, ptr %environment.i8, align 8, !noalias !0
  %v_coe_3366_46_73_237_4169.elt4 = getelementptr i8, ptr %fields_63, i64 24
  %v_coe_3366_46_73_237_4169.unpack5 = load ptr, ptr %v_coe_3366_46_73_237_4169.elt4, align 8, !noalias !0
  %isNull.i.i = icmp eq ptr %v_coe_3366_46_73_237_4169.unpack5, null
  br i1 %isNull.i.i, label %next.i10, label %next.i.i

next.i.i:                                         ; preds = %label_87
  %referenceCount.i.i = load i64, ptr %v_coe_3366_46_73_237_4169.unpack5, align 4
  %referenceCount.1.i.i = add i64 %referenceCount.i.i, 1
  store i64 %referenceCount.1.i.i, ptr %v_coe_3366_46_73_237_4169.unpack5, align 4
  br label %next.i10

next.i10:                                         ; preds = %next.i.i, %label_87
  %referenceCount.i11 = load i64, ptr %fields_63, align 4
...
decr.i13:                                         ; preds = %next.i10
  ...
  store i64 %referenceCount.1.i14, ptr %fields_63, align 4
  br label %eraseObject.exit19

free.i15:                                         ; preds = %next.i10
  %objectEraser.i16 = getelementptr i8, ptr %fields_63, i64 8
  %eraser.i17 = load ptr, ptr %objectEraser.i16, align 8
  tail call void %eraser.i17(ptr nonnull %environment.i8)
  tail call void @free(ptr nonnull %fields_63)
  br label %eraseObject.exit19

eraseObject.exit19:                               ; preds = %decr.i13, %free.i15
  %z.i112 = icmp sgt i64 %v_coe_3366_46_73_237_4169.unpack, 47
  br i1 %z.i112, label %label_86, label %label_75

label_94:                                         ; preds = %entry
  %isNull.i = icmp eq ptr %fields_63, null
  br i1 %isNull.i, label %eraseObject.exit, label %next.i

next.i:                                           ; preds = %label_94
  %referenceCount.i = load i64, ptr %fields_63, align 4
  %cond.i = icmp eq i64 %referenceCount.i, 0
  br i1 %cond.i, label %free.i, label %decr.i

decr.i:                                           ; preds = %next.i
  %referenceCount.1.i = add i64 %referenceCount.i, -1
  store i64 %referenceCount.1.i, ptr %fields_63, align 4
  br label %eraseObject.exit

free.i:                                           ; preds = %next.i
  %objectEraser.i = getelementptr i8, ptr %fields_63, i64 8
  %eraser.i = load ptr, ptr %objectEraser.i, align 8
  %environment.i.i = getelementptr i8, ptr %fields_63, i64 16
  tail call void %eraser.i(ptr %environment.i.i)
  tail call void @free(ptr nonnull %fields_63)
  br label %eraseObject.exit

eraseObject.exit:                                 ; preds = %label_94, %decr.i, %free.i
  %isNull.i.i20 = icmp eq ptr %v_r_2464_30_194_4172.unpack2, null
  br i1 %isNull.i.i20, label %erasePositive.exit, label %next.i.i21

next.i.i21:                                       ; preds = %eraseObject.exit
  %referenceCount.i.i22 = load i64, ptr %v_r_2464_30_194_4172.unpack2, align 4
...
decr.i.i:                                         ; preds = %next.i.i21
  ...
  store i64 %referenceCount.1.i.i23, ptr %v_r_2464_30_194_4172.unpack2, align 4
  br label %erasePositive.exit

free.i.i:                                         ; preds = %next.i.i21
  %objectEraser.i.i = getelementptr i8, ptr %v_r_2464_30_194_4172.unpack2, i64 8
  %eraser.i.i = load ptr, ptr %objectEraser.i.i, align 8
  %environment.i.i.i = getelementptr i8, ptr %v_r_2464_30_194_4172.unpack2, i64 16
  tail call void %eraser.i.i(ptr %environment.i.i.i)
  tail call void @free(ptr nonnull %v_r_2464_30_194_4172.unpack2)
  br label %erasePositive.exit
...
erasePositive.exit:                               ; preds = %eraseObject.exit, %decr.i.i, %free.i.i
  ...
  %returnAddress_91 = load ptr, ptr %newStackPointer.i120, align 8, !noalias !0
  musttail call tailcc void %returnAddress_91(i64 %acc_8_35_199_4210, ptr nonnull %stack)
  ret void
}

define void @sharer_100(ptr %stackPointer) {
entry:
  %v_r_2464_30_194_4172_97.elt1 = getelementptr i8, ptr %stackPointer, i64 -24
  %v_r_2464_30_194_4172_97.unpack2 = load ptr, ptr %v_r_2464_30_194_4172_97.elt1, align 8, !noalias !0
  %isNull.i.i = icmp eq ptr %v_r_2464_30_194_4172_97.unpack2, null
  br i1 %isNull.i.i, label %sharePositive.exit, label %next.i.i

next.i.i:                                         ; preds = %entry
  %referenceCount.i.i = load i64, ptr %v_r_2464_30_194_4172_97.unpack2, align 4
  %referenceCount.1.i.i = add i64 %referenceCount.i.i, 1
  store i64 %referenceCount.1.i.i, ptr %v_r_2464_30_194_4172_97.unpack2, align 4
...
define void @eraser_112(ptr %stackPointer) {
entry:
  %v_r_2464_30_194_4172_109.elt1 = getelementptr i8, ptr %stackPointer, i64 -24
  %v_r_2464_30_194_4172_109.unpack2 = load ptr, ptr %v_r_2464_30_194_4172_109.elt1, align 8, !noalias !0
  %isNull.i.i = icmp eq ptr %v_r_2464_30_194_4172_109.unpack2, null
  br i1 %isNull.i.i, label %erasePositive.exit, label %next.i.i

next.i.i:                                         ; preds = %entry
  %referenceCount.i.i = load i64, ptr %v_r_2464_30_194_4172_109.unpack2, align 4
  %cond.i.i = icmp eq i64 %referenceCount.i.i, 0
  br i1 %cond.i.i, label %free.i.i, label %decr.i.i

decr.i.i:                                         ; preds = %next.i.i
  %referenceCount.1.i.i = add i64 %referenceCount.i.i, -1
  store i64 %referenceCount.1.i.i, ptr %v_r_2464_30_194_4172_109.unpack2, align 4
  br label %erasePositive.exit

free.i.i:                                         ; preds = %next.i.i
  %objectEraser.i.i = getelementptr i8, ptr %v_r_2464_30_194_4172_109.unpack2, i64 8
  %eraser.i.i = load ptr, ptr %objectEraser.i.i, align 8
  %environment.i.i.i = getelementptr i8, ptr %v_r_2464_30_194_4172_109.unpack2, i64 16
  tail call void %eraser.i.i(ptr %environment.i.i.i)
  tail call void @free(ptr nonnull %v_r_2464_30_194_4172_109.unpack2)
  br label %erasePositive.exit
...
define tailcc void @returnAddress_129(%Pos %returned_4493, ptr nocapture %stack) {
entry:
  %stackMemory.i = getelementptr i8, ptr %stack, i64 8
  %stackPrompt.i = getelementptr i8, ptr %stack, i64 32
  %stackRest.i = getelementptr i8, ptr %stack, i64 40
...
underflowStack.exit:                              ; preds = %decrement.i.i, %free.i.i
  ...
  %newStackPointer.i = getelementptr i8, ptr %stackPointer.i, i64 -24
  store ptr %newStackPointer.i, ptr %stackPointer_pointer.i, align 8, !alias.scope !0
  %returnAddress_131 = load ptr, ptr %newStackPointer.i, align 8, !noalias !0
  musttail call tailcc void %returnAddress_131(%Pos %returned_4493, ptr %rest.i)
  ret void
}

define tailcc void @Exception_7_19_46_210_4294_clause_138(ptr %closure, %Pos %exc_8_20_47_211_4262, %Pos %msg_9_21_48_212_4232, ptr %stack) {
next.i:
  %environment.i5 = getelementptr i8, ptr %closure, i64 16
  %p_6_18_45_209_4147 = load ptr, ptr %environment.i5, align 8, !noalias !0
...
eraseObject.exit:                                 ; preds = %decr.i, %free.i
  %pair_141 = tail call <{ ptr, ptr }> @shift(ptr %stack, ptr %p_6_18_45_209_4147)
  %k_11_23_50_214_4312 = extractvalue <{ ptr, ptr }> %pair_141, 0
  %referenceCount.i7 = load i64, ptr %k_11_23_50_214_4312, align 4
...
decr.i9:                                          ; preds = %eraseObject.exit
  ...
  store i64 %referenceCount.1.i10, ptr %k_11_23_50_214_4312, align 4
  br label %eraseResumption.exit

free.i11:                                         ; preds = %eraseObject.exit
  %stack_pointer.i = getelementptr i8, ptr %k_11_23_50_214_4312, i64 40
  %stack.i = load ptr, ptr %stack_pointer.i, align 8
  store ptr null, ptr %stack_pointer.i, align 8
  br label %tailrecurse.i
...
eraseResumption.exit:                             ; preds = %erasePrompt.exit.i, %decr.i9
  ...
  store ptr @eraser_34, ptr %objectEraser.i, align 8
  %environment.i = getelementptr i8, ptr %object.i, i64 16
  %exc_8_20_47_211_4262.elt = extractvalue %Pos %exc_8_20_47_211_4262, 0
  store i64 %exc_8_20_47_211_4262.elt, ptr %environment.i, align 8, !noalias !0
  %environment_144.repack1 = getelementptr i8, ptr %object.i, i64 24
  %exc_8_20_47_211_4262.elt2 = extractvalue %Pos %exc_8_20_47_211_4262, 1
  store ptr %exc_8_20_47_211_4262.elt2, ptr %environment_144.repack1, align 8, !noalias !0
  %msg_9_21_48_212_4232_pointer_148 = getelementptr i8, ptr %object.i, i64 32
  %msg_9_21_48_212_4232.elt = extractvalue %Pos %msg_9_21_48_212_4232, 0
  store i64 %msg_9_21_48_212_4232.elt, ptr %msg_9_21_48_212_4232_pointer_148, align 8, !noalias !0
  %msg_9_21_48_212_4232_pointer_148.repack3 = getelementptr i8, ptr %object.i, i64 40
  %msg_9_21_48_212_4232.elt4 = extractvalue %Pos %msg_9_21_48_212_4232, 1
  store ptr %msg_9_21_48_212_4232.elt4, ptr %msg_9_21_48_212_4232_pointer_148.repack3, align 8, !noalias !0
  %make_4494 = insertvalue %Pos zeroinitializer, ptr %object.i, 1
  %stackPointer_pointer.i14 = getelementptr i8, ptr %stack_142, i64 8
  ...
  musttail call tailcc void %returnAddress_150(%Pos %make_4494, ptr %stack_142)
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define void @eraser_157(ptr nocapture readnone %environment) #5 {
entry:
  ret void
}

define void @eraser_165(ptr nocapture readonly %environment) {
entry:
  %tmp_4421_164.elt1 = getelementptr inbounds i8, ptr %environment, i64 8
  %tmp_4421_164.unpack2 = load ptr, ptr %tmp_4421_164.elt1, align 8, !noalias !0
  %isNull.i.i = icmp eq ptr %tmp_4421_164.unpack2, null
  br i1 %isNull.i.i, label %erasePositive.exit, label %next.i.i

next.i.i:                                         ; preds = %entry
  %referenceCount.i.i = load i64, ptr %tmp_4421_164.unpack2, align 4
  %cond.i.i = icmp eq i64 %referenceCount.i.i, 0
  br i1 %cond.i.i, label %free.i.i, label %decr.i.i

decr.i.i:                                         ; preds = %next.i.i
  %referenceCount.1.i.i = add i64 %referenceCount.i.i, -1
  store i64 %referenceCount.1.i.i, ptr %tmp_4421_164.unpack2, align 4
  br label %erasePositive.exit

free.i.i:                                         ; preds = %next.i.i
  %objectEraser.i.i = getelementptr i8, ptr %tmp_4421_164.unpack2, i64 8
  %eraser.i.i = load ptr, ptr %objectEraser.i.i, align 8
  %environment.i.i.i = getelementptr i8, ptr %tmp_4421_164.unpack2, i64 16
  tail call void %eraser.i.i(ptr %environment.i.i.i)
  tail call void @free(ptr nonnull %tmp_4421_164.unpack2)
  br label %erasePositive.exit
...
define tailcc void @returnAddress_161(i64 %v_coe_3365_6_28_55_219_4031, ptr %stack) {
entry:
  %stackPointer_pointer.i = getelementptr i8, ptr %stack, i64 8
  %stackPointer.i = load ptr, ptr %stackPointer_pointer.i, align 8, !alias.scope !0
  %oldStackPointer.i = getelementptr i8, ptr %stackPointer.i, i64 24
  ...
  %objectEraser.i = getelementptr i8, ptr %object.i, i64 8
  store i64 0, ptr %object.i, align 4
  store ptr @eraser_165, ptr %objectEraser.i, align 8
  %environment.i = getelementptr i8, ptr %object.i, i64 16
  store i64 %v_coe_3365_6_28_55_219_4031, ptr %environment.i, align 8, !noalias !0
  %environment_163.repack1 = getelementptr i8, ptr %object.i, i64 24
  store ptr null, ptr %environment_163.repack1, align 8, !noalias !0
  %make_4496 = insertvalue %Pos { i64 1, ptr null }, ptr %object.i, 1
  ...
  musttail call tailcc void %returnAddress_169(%Pos %make_4496, ptr %stack)
  ret void
}

define tailcc void @go_6_33_197_4123(i64 %index_7_34_198_4062, i64 %acc_8_35_199_4210, i64 %tmp_4419, %Pos %v_r_2464_30_194_4172, ptr %p_8_9_3988, ptr %stack) local_unnamed_addr {
entry:
  %object.i3 = extractvalue %Pos %v_r_2464_30_194_4172, 1
...
stackAllocate.exit:                               ; preds = %sharePositive.exit, %realloc.i
  ...
  store i64 %acc_8_35_199_4210, ptr %common.ret.op.i, align 4, !noalias !0
  %tmp_4419_pointer_121 = getelementptr i8, ptr %common.ret.op.i, i64 8
  store i64 %tmp_4419, ptr %tmp_4419_pointer_121, align 4, !noalias !0
  %v_r_2464_30_194_4172_pointer_122 = getelementptr i8, ptr %common.ret.op.i, i64 16
  %v_r_2464_30_194_4172.elt = extractvalue %Pos %v_r_2464_30_194_4172, 0
  store i64 %v_r_2464_30_194_4172.elt, ptr %v_r_2464_30_194_4172_pointer_122, align 8, !noalias !0
  %v_r_2464_30_194_4172_pointer_122.repack1 = getelementptr i8, ptr %common.ret.op.i, i64 24
  store ptr %object.i3, ptr %v_r_2464_30_194_4172_pointer_122.repack1, align 8, !noalias !0
  %p_8_9_3988_pointer_123 = getelementptr i8, ptr %common.ret.op.i, i64 32
  store ptr %p_8_9_3988, ptr %p_8_9_3988_pointer_123, align 8, !noalias !0
  %index_7_34_198_4062_pointer_124 = getelementptr i8, ptr %common.ret.op.i, i64 40
  store i64 %index_7_34_198_4062, ptr %index_7_34_198_4062_pointer_124, align 4, !noalias !0
  %returnAddress_pointer_125 = getelementptr i8, ptr %common.ret.op.i, i64 48
  %sharer_pointer_126 = getelementptr i8, ptr %common.ret.op.i, i64 56
  %eraser_pointer_127 = getelementptr i8, ptr %common.ret.op.i, i64 64
  store ptr @returnAddress_55, ptr %returnAddress_pointer_125, align 8, !noalias !0
  store ptr @sharer_100, ptr %sharer_pointer_126, align 8, !noalias !0
  store ptr @eraser_112, ptr %eraser_pointer_127, align 8, !noalias !0
...
stackAllocate.exit26:                             ; preds = %stackAllocate.exit, %realloc.i12
  ...
  %sharer_pointer_136 = getelementptr i8, ptr %base.i37, i64 8
  %eraser_pointer_137 = getelementptr i8, ptr %base.i37, i64 16
  store ptr @returnAddress_129, ptr %base.i37, align 8, !noalias !0
  store ptr @sharer_19, ptr %sharer_pointer_136, align 8, !noalias !0
  store ptr @eraser_21, ptr %eraser_pointer_137, align 8, !noalias !0
...
stackAllocate.exit49:                             ; preds = %stackAllocate.exit26, %realloc.i35
  ...
  %Exception_7_19_46_210_4294 = insertvalue %Neg { ptr @vtable_153, ptr null }, ptr %object.i, 1
  store ptr %nextStackPointer.sink.i33, ptr %stack.repack1.i, align 8
  %sharer_pointer_174 = getelementptr i8, ptr %common.ret.op.i34, i64 8
  %eraser_pointer_175 = getelementptr i8, ptr %common.ret.op.i34, i64 16
  store ptr @returnAddress_161, ptr %common.ret.op.i34, align 8, !noalias !0
  store ptr @sharer_5, ptr %sharer_pointer_174, align 8, !noalias !0
  store ptr @eraser_7, ptr %eraser_pointer_175, align 8, !noalias !0
  musttail call tailcc void @charAt_2108(%Pos %v_r_2464_30_194_4172, i64 %index_7_34_198_4062, %Neg %Exception_7_19_46_210_4294, ptr nonnull %stack.i)
  ret void
}

define tailcc void @Exception_9_106_133_297_4223_clause_176(ptr %closure, %Pos %exception_10_107_134_298_4497, %Pos %msg_11_108_135_299_4498, ptr %stack) {
next.i:
  %environment.i = getelementptr i8, ptr %closure, i64 16
  %p_8_9_3988 = load ptr, ptr %environment.i, align 8, !noalias !0
  %referenceCount.i = load i64, ptr %closure, align 4
  %cond.i = icmp eq i64 %referenceCount.i, 0
  br i1 %cond.i, label %free.i, label %decr.i
...
eraseObject.exit:                                 ; preds = %decr.i, %free.i
  %object.i1 = extractvalue %Pos %exception_10_107_134_298_4497, 1
...
erasePositive.exit12:                             ; preds = %eraseObject.exit, %decr.i.i6, %free.i.i8
  %object.i = extractvalue %Pos %msg_11_108_135_299_4498, 1
  %isNull.i.i = icmp eq ptr %object.i, null
  br i1 %isNull.i.i, label %erasePositive.exit, label %next.i.i
...
erasePositive.exit:                               ; preds = %erasePositive.exit12, %decr.i.i, %free.i.i
  %pair_179 = tail call <{ ptr, ptr }> @shift(ptr %stack, ptr %p_8_9_3988)
  %k_13_14_4_4402 = extractvalue <{ ptr, ptr }> %pair_179, 0
  %referenceCount.i13 = load i64, ptr %k_13_14_4_4402, align 4
...
decr.i15:                                         ; preds = %erasePositive.exit
  ...
  store i64 %referenceCount.1.i16, ptr %k_13_14_4_4402, align 4
  br label %eraseResumption.exit

free.i17:                                         ; preds = %erasePositive.exit
  %stack_pointer.i = getelementptr i8, ptr %k_13_14_4_4402, i64 40
  %stack.i = load ptr, ptr %stack_pointer.i, align 8
  store ptr null, ptr %stack_pointer.i, align 8
  br label %tailrecurse.i
...
eraseResumption.exit:                             ; preds = %erasePrompt.exit.i, %decr.i15
  ...
  %stackPointer_pointer.i24 = getelementptr i8, ptr %stack_180, i64 8
  %stackPointer.i25 = load ptr, ptr %stackPointer_pointer.i24, align 8, !alias.scope !0
  %limit_pointer.i = getelementptr i8, ptr %stack_180, i64 24
  %limit.i = load ptr, ptr %limit_pointer.i, align 8, !alias.scope !0
  ...
  %returnAddress_181 = load ptr, ptr %newStackPointer.i, align 8, !noalias !0
  musttail call tailcc void %returnAddress_181(%Pos { i64 5, ptr null }, ptr %stack_180)
  ret void
}

define tailcc void @returnAddress_195(i64 %v_coe_3370_22_131_158_322_4240, ptr %stack) {
entry:
  %stackPointer_pointer.i = getelementptr i8, ptr %stack, i64 8
  %stackPointer.i = load ptr, ptr %stackPointer_pointer.i, align 8, !alias.scope !0
  %oldStackPointer.i = getelementptr i8, ptr %stackPointer.i, i64 24
  ...
  %isInside.i = icmp ule ptr %oldStackPointer.i, %limit.i
  tail call void @llvm.assume(i1 %isInside.i)
  %boxed1.i = insertvalue %Pos zeroinitializer, i64 %v_coe_3370_22_131_158_322_4240, 0
  %boxed2.i2 = insertvalue %Pos %boxed1.i, ptr null, 1
  %isInside.i7 = icmp ule ptr %stackPointer.i, %limit.i
  tail call void @llvm.assume(i1 %isInside.i7)
  %newStackPointer.i = getelementptr i8, ptr %stackPointer.i, i64 -24
  store ptr %newStackPointer.i, ptr %stackPointer_pointer.i, align 8, !alias.scope !0
  %returnAddress_196 = load ptr, ptr %newStackPointer.i, align 8, !noalias !0
  musttail call tailcc void %returnAddress_196(%Pos %boxed2.i2, ptr %stack)
  ret void
}

define tailcc void @returnAddress_207(i64 %v_r_2562_1_9_20_129_156_320_4149, ptr %stack) {
entry:
  %stackPointer_pointer.i = getelementptr i8, ptr %stack, i64 8
  %stackPointer.i = load ptr, ptr %stackPointer_pointer.i, align 8, !alias.scope !0
  %oldStackPointer.i = getelementptr i8, ptr %stackPointer.i, i64 24
  ...
  %isInside.i = icmp ule ptr %oldStackPointer.i, %limit.i
  tail call void @llvm.assume(i1 %isInside.i)
  %z.i = sub i64 0, %v_r_2562_1_9_20_129_156_320_4149
  %isInside.i5 = icmp ule ptr %stackPointer.i, %limit.i
  tail call void @llvm.assume(i1 %isInside.i5)
  %newStackPointer.i = getelementptr i8, ptr %stackPointer.i, i64 -24
  store ptr %newStackPointer.i, ptr %stackPointer_pointer.i, align 8, !alias.scope !0
  %returnAddress_208 = load ptr, ptr %newStackPointer.i, align 8, !noalias !0
  musttail call tailcc void %returnAddress_208(i64 %z.i, ptr %stack)
  ret void
}

define tailcc void @returnAddress_190(i64 %v_r_2561_3_14_123_150_314_4063, ptr %stack) {
entry:
  %stackPointer_pointer.i = getelementptr i8, ptr %stack, i64 8
  %stackPointer.i = load ptr, ptr %stackPointer_pointer.i, align 8, !alias.scope !0
  %oldStackPointer.i = getelementptr i8, ptr %stackPointer.i, i64 24
  ...
  store ptr %newStackPointer.i, ptr %stackPointer_pointer.i, align 8, !alias.scope !0
  %tmp_4419 = load i64, ptr %newStackPointer.i, align 4, !noalias !0
  %v_r_2464_30_194_4172_pointer_193 = getelementptr i8, ptr %stackPointer.i, i64 -24
  %v_r_2464_30_194_4172.unpack = load i64, ptr %v_r_2464_30_194_4172_pointer_193, align 8, !noalias !0
  %0 = insertvalue %Pos poison, i64 %v_r_2464_30_194_4172.unpack, 0
  %v_r_2464_30_194_4172.elt1 = getelementptr i8, ptr %stackPointer.i, i64 -16
  %v_r_2464_30_194_4172.unpack2 = load ptr, ptr %v_r_2464_30_194_4172.elt1, align 8, !noalias !0
  %v_r_2464_30_194_41723 = insertvalue %Pos %0, ptr %v_r_2464_30_194_4172.unpack2, 1
  %p_8_9_3988_pointer_194 = getelementptr i8, ptr %stackPointer.i, i64 -8
  %p_8_9_3988 = load ptr, ptr %p_8_9_3988_pointer_194, align 8, !noalias !0
  %z.i = icmp eq i64 %v_r_2561_3_14_123_150_314_4063, 45
  %isInside.not.i = icmp ugt ptr %p_8_9_3988_pointer_194, %limit.i
  br i1 %isInside.not.i, label %realloc.i, label %stackAllocate.exit
...
stackAllocate.exit:                               ; preds = %entry, %realloc.i
  ...
  %nextStackPointer.sink.i = phi ptr [ %newNextStackPointer.i, %realloc.i ], [ %p_8_9_3988_pointer_194, %entry ]
  %common.ret.op.i = phi ptr [ %newStackPointer.i12, %realloc.i ], [ %newStackPointer.i, %entry ]
  store ptr %nextStackPointer.sink.i, ptr %stackPointer_pointer.i, align 8
  %sharer_pointer_201 = getelementptr i8, ptr %common.ret.op.i, i64 8
  %eraser_pointer_202 = getelementptr i8, ptr %common.ret.op.i, i64 16
  store ptr @returnAddress_195, ptr %common.ret.op.i, align 8, !noalias !0
  store ptr @sharer_5, ptr %sharer_pointer_201, align 8, !noalias !0
  store ptr @eraser_7, ptr %eraser_pointer_202, align 8, !noalias !0
  br i1 %z.i, label %label_215, label %label_206

label_206:                                        ; preds = %stackAllocate.exit
  musttail call tailcc void @go_6_33_197_4123(i64 0, i64 0, i64 %tmp_4419, %Pos %v_r_2464_30_194_41723, ptr %p_8_9_3988, ptr nonnull %stack)
  ret void

label_215:                                        ; preds = %stackAllocate.exit
...
stackAllocate.exit35:                             ; preds = %label_215, %realloc.i21
  %nextStackPointer.sink.i19 = phi ptr [ %newNextStackPointer.i34, %realloc.i21 ], [ %nextStackPointer.i17, %label_215 ]
  %common.ret.op.i20 = phi ptr [ %newStackPointer.i33, %realloc.i21 ], [ %nextStackPointer.sink.i, %label_215 ]
  store ptr %nextStackPointer.sink.i19, ptr %stackPointer_pointer.i, align 8
  %sharer_pointer_213 = getelementptr i8, ptr %common.ret.op.i20, i64 8
  %eraser_pointer_214 = getelementptr i8, ptr %common.ret.op.i20, i64 16
  store ptr @returnAddress_207, ptr %common.ret.op.i20, align 8, !noalias !0
  store ptr @sharer_5, ptr %sharer_pointer_213, align 8, !noalias !0
  store ptr @eraser_7, ptr %eraser_pointer_214, align 8, !noalias !0
  musttail call tailcc void @go_6_33_197_4123(i64 1, i64 0, i64 %tmp_4419, %Pos %v_r_2464_30_194_41723, ptr %p_8_9_3988, ptr nonnull %stack)
  ret void
}

define void @sharer_219(ptr %stackPointer) {
entry:
  %v_r_2464_30_194_4172_217.elt1 = getelementptr i8, ptr %stackPointer, i64 -16
  %v_r_2464_30_194_4172_217.unpack2 = load ptr, ptr %v_r_2464_30_194_4172_217.elt1, align 8, !noalias !0
  %isNull.i.i = icmp eq ptr %v_r_2464_30_194_4172_217.unpack2, null
  br i1 %isNull.i.i, label %sharePositive.exit, label %next.i.i

next.i.i:                                         ; preds = %entry
  %referenceCount.i.i = load i64, ptr %v_r_2464_30_194_4172_217.unpack2, align 4
  %referenceCount.1.i.i = add i64 %referenceCount.i.i, 1
  store i64 %referenceCount.1.i.i, ptr %v_r_2464_30_194_4172_217.unpack2, align 4
  br label %sharePositive.exit
...
define void @eraser_227(ptr %stackPointer) {
entry:
  %v_r_2464_30_194_4172_225.elt1 = getelementptr i8, ptr %stackPointer, i64 -16
  %v_r_2464_30_194_4172_225.unpack2 = load ptr, ptr %v_r_2464_30_194_4172_225.elt1, align 8, !noalias !0
  %isNull.i.i = icmp eq ptr %v_r_2464_30_194_4172_225.unpack2, null
  br i1 %isNull.i.i, label %erasePositive.exit, label %next.i.i

next.i.i:                                         ; preds = %entry
  %referenceCount.i.i = load i64, ptr %v_r_2464_30_194_4172_225.unpack2, align 4
  %cond.i.i = icmp eq i64 %referenceCount.i.i, 0
  br i1 %cond.i.i, label %free.i.i, label %decr.i.i

decr.i.i:                                         ; preds = %next.i.i
  %referenceCount.1.i.i = add i64 %referenceCount.i.i, -1
  store i64 %referenceCount.1.i.i, ptr %v_r_2464_30_194_4172_225.unpack2, align 4
  br label %erasePositive.exit

free.i.i:                                         ; preds = %next.i.i
  %objectEraser.i.i = getelementptr i8, ptr %v_r_2464_30_194_4172_225.unpack2, i64 8
  %eraser.i.i = load ptr, ptr %objectEraser.i.i, align 8
  %environment.i.i.i = getelementptr i8, ptr %v_r_2464_30_194_4172_225.unpack2, i64 16
  tail call void %eraser.i.i(ptr %environment.i.i.i)
  tail call void @free(ptr nonnull %v_r_2464_30_194_4172_225.unpack2)
  br label %erasePositive.exit
...
define tailcc void @returnAddress_52(%Pos %v_r_2464_30_194_4172, ptr %stack) {
entry:
  %stackPointer_pointer.i = getelementptr i8, ptr %stack, i64 8
  %stackPointer.i = load ptr, ptr %stackPointer_pointer.i, align 8, !alias.scope !0
  %oldStackPointer.i = getelementptr i8, ptr %stackPointer.i, i64 24
  ...
  store ptr %newStackPointer.i, ptr %stackPointer_pointer.i, align 8, !alias.scope !0
  %p_8_9_3988 = load ptr, ptr %newStackPointer.i, align 8, !noalias !0
  %object.i = tail call dereferenceable_or_null(24) ptr @malloc(i64 24)
  %objectEraser.i = getelementptr i8, ptr %object.i, i64 8
  store i64 0, ptr %object.i, align 4
  store ptr @eraser_157, ptr %objectEraser.i, align 8
  %environment.i = getelementptr i8, ptr %object.i, i64 16
  store ptr %p_8_9_3988, ptr %environment.i, align 8, !noalias !0
  %object.i3 = extractvalue %Pos %v_r_2464_30_194_4172, 1
  %isNull.i.i = icmp eq ptr %object.i3, null
  br i1 %isNull.i.i, label %sharePositive.exit, label %next.i.i
...
stackAllocate.exit:                               ; preds = %sharePositive.exit, %realloc.i
  ...
  %v_r_2464_30_194_4172_pointer_234 = getelementptr i8, ptr %common.ret.op.i, i64 8
  %v_r_2464_30_194_4172.elt = extractvalue %Pos %v_r_2464_30_194_4172, 0
  store i64 %v_r_2464_30_194_4172.elt, ptr %v_r_2464_30_194_4172_pointer_234, align 8, !noalias !0
  %v_r_2464_30_194_4172_pointer_234.repack1 = getelementptr i8, ptr %common.ret.op.i, i64 16
  store ptr %object.i3, ptr %v_r_2464_30_194_4172_pointer_234.repack1, align 8, !noalias !0
  %p_8_9_3988_pointer_235 = getelementptr i8, ptr %common.ret.op.i, i64 24
  store ptr %p_8_9_3988, ptr %p_8_9_3988_pointer_235, align 8, !noalias !0
  %returnAddress_pointer_236 = getelementptr i8, ptr %common.ret.op.i, i64 32
  %sharer_pointer_237 = getelementptr i8, ptr %common.ret.op.i, i64 40
  %eraser_pointer_238 = getelementptr i8, ptr %common.ret.op.i, i64 48
  store ptr @returnAddress_190, ptr %returnAddress_pointer_236, align 8, !noalias !0
  store ptr @sharer_219, ptr %sharer_pointer_237, align 8, !noalias !0
  store ptr @eraser_227, ptr %eraser_pointer_238, align 8, !noalias !0
...
stackAllocate.exit.i:                             ; preds = %realloc.i.i, %sharePositive.exit.i
  ...
  store i64 %v_r_2464_30_194_4172.elt, ptr %common.ret.op.i.i, align 8, !noalias !0
  %stackPointer_333.repack1.i = getelementptr inbounds i8, ptr %common.ret.op.i.i, i64 8
  store ptr %object.i3, ptr %stackPointer_333.repack1.i, align 8, !noalias !0
  %index_2107_pointer_335.i = getelementptr i8, ptr %common.ret.op.i.i, i64 16
  store i64 0, ptr %index_2107_pointer_335.i, align 4, !noalias !0
  %Exception_2362_pointer_336.i = getelementptr i8, ptr %common.ret.op.i.i, i64 24
  store ptr @vtable_184, ptr %Exception_2362_pointer_336.i, align 8, !noalias !0
  %Exception_2362_pointer_336.repack3.i = getelementptr i8, ptr %common.ret.op.i.i, i64 32
  store ptr %object.i, ptr %Exception_2362_pointer_336.repack3.i, align 8, !noalias !0
  %returnAddress_pointer_337.i = getelementptr i8, ptr %common.ret.op.i.i, i64 40
  %sharer_pointer_338.i = getelementptr i8, ptr %common.ret.op.i.i, i64 48
  %eraser_pointer_339.i = getelementptr i8, ptr %common.ret.op.i.i, i64 56
  store ptr @returnAddress_299, ptr %returnAddress_pointer_337.i, align 8, !noalias !0
  store ptr @sharer_320, ptr %sharer_pointer_338.i, align 8, !noalias !0
  store ptr @eraser_328, ptr %eraser_pointer_339.i, align 8, !noalias !0
  %x.i.i = tail call i64 @c_bytearray_size(%Pos %v_r_2464_30_194_4172)
  ...
  %returnAddress_343.i = load ptr, ptr %newStackPointer.i16.i, align 8, !noalias !0
  musttail call tailcc void %returnAddress_343.i(%Pos %adt_boolean.i12.i, ptr nonnull %stack)
  ret void
}

define void @sharer_240(ptr %stackPointer) {
entry:
...
define void @eraser_244(ptr %stackPointer) {
entry:
  %newStackPointer.i = getelementptr i8, ptr %stackPointer, i64 -32
...
define tailcc void @returnAddress_49(%Pos %v_r_2463_24_188_4130, ptr %stack) {
stackAllocate.exit:
  %stackPointer_pointer.i = getelementptr i8, ptr %stack, i64 8
  %stackPointer.i = load ptr, ptr %stackPointer_pointer.i, align 8, !alias.scope !0
  %oldStackPointer.i = getelementptr i8, ptr %stackPointer.i, i64 24
  ...
  store ptr %p_8_9_3988, ptr %newStackPointer.i, align 8, !noalias !0
  %sharer_pointer_250 = getelementptr i8, ptr %stackPointer.i, i64 8
  %eraser_pointer_251 = getelementptr i8, ptr %stackPointer.i, i64 16
  store ptr @returnAddress_52, ptr %stackPointer.i, align 8, !noalias !0
  store ptr @sharer_240, ptr %sharer_pointer_250, align 8, !noalias !0
  store ptr @eraser_244, ptr %eraser_pointer_251, align 8, !noalias !0
  %tag_252 = extractvalue %Pos %v_r_2463_24_188_4130, 0
  switch i64 %tag_252, label %label_254 [
    i64 0, label %label_258
    i64 1, label %label_264
  ]

label_254:                                        ; preds = %stackAllocate.exit
  ret void

label_258:                                        ; preds = %stackAllocate.exit
  %utf8StringLiteral_4513 = tail call %Pos @c_bytearray_construct(i64 0, ptr nonnull @utf8StringLiteral_4513.lit)
  ...
  %returnAddress_255 = load ptr, ptr %newStackPointer.i18, align 8, !noalias !0
  musttail call tailcc void %returnAddress_255(%Pos %utf8StringLiteral_4513, ptr nonnull %stack)
  ret void

label_264:                                        ; preds = %stackAllocate.exit
  %fields_253 = extractvalue %Pos %v_r_2463_24_188_4130, 1
  %environment.i = getelementptr i8, ptr %fields_253, i64 16
  %v_y_3192_8_29_193_4040.unpack = load i64, ptr %environment.i, align 8, !noalias !0
  %v_y_3192_8_29_193_4040.elt1 = getelementptr i8, ptr %fields_253, i64 24
  %v_y_3192_8_29_193_4040.unpack2 = load ptr, ptr %v_y_3192_8_29_193_4040.elt1, align 8, !noalias !0
  %isNull.i.i = icmp eq ptr %v_y_3192_8_29_193_4040.unpack2, null
  br i1 %isNull.i.i, label %next.i, label %next.i.i

next.i.i:                                         ; preds = %label_264
  %referenceCount.i.i = load i64, ptr %v_y_3192_8_29_193_4040.unpack2, align 4
  %referenceCount.1.i.i = add i64 %referenceCount.i.i, 1
  store i64 %referenceCount.1.i.i, ptr %v_y_3192_8_29_193_4040.unpack2, align 4
  br label %next.i

next.i:                                           ; preds = %next.i.i, %label_264
  %referenceCount.i = load i64, ptr %fields_253, align 4
  %cond.i = icmp eq i64 %referenceCount.i, 0
  br i1 %cond.i, label %free.i, label %decr.i

decr.i:                                           ; preds = %next.i
  %referenceCount.1.i = add i64 %referenceCount.i, -1
  store i64 %referenceCount.1.i, ptr %fields_253, align 4
  br label %eraseObject.exit

free.i:                                           ; preds = %next.i
  %objectEraser.i = getelementptr i8, ptr %fields_253, i64 8
  %eraser.i = load ptr, ptr %objectEraser.i, align 8
  tail call void %eraser.i(ptr nonnull %environment.i)
  tail call void @free(ptr nonnull %fields_253)
  br label %eraseObject.exit

eraseObject.exit:                                 ; preds = %decr.i, %free.i
  %0 = insertvalue %Pos poison, i64 %v_y_3192_8_29_193_4040.unpack, 0
  %v_y_3192_8_29_193_40403 = insertvalue %Pos %0, ptr %v_y_3192_8_29_193_4040.unpack2, 1
  ...
  %returnAddress_261 = load ptr, ptr %newStackPointer.i24, align 8, !noalias !0
  musttail call tailcc void %returnAddress_261(%Pos %v_y_3192_8_29_193_40403, ptr nonnull %stack)
  ret void
}

define tailcc void @returnAddress_46(%Pos %v_r_2462_13_177_4109, ptr %stack) {
stackAllocate.exit:
  %stackPointer_pointer.i = getelementptr i8, ptr %stack, i64 8
  %stackPointer.i = load ptr, ptr %stackPointer_pointer.i, align 8, !alias.scope !0
  %oldStackPointer.i = getelementptr i8, ptr %stackPointer.i, i64 24
  ...
  store ptr %oldStackPointer.i, ptr %stackPointer_pointer.i, align 8
  store ptr %p_8_9_3988, ptr %newStackPointer.i, align 8, !noalias !0
  %sharer_pointer_270 = getelementptr i8, ptr %stackPointer.i, i64 8
  %eraser_pointer_271 = getelementptr i8, ptr %stackPointer.i, i64 16
  store ptr @returnAddress_49, ptr %stackPointer.i, align 8, !noalias !0
  store ptr @sharer_240, ptr %sharer_pointer_270, align 8, !noalias !0
  store ptr @eraser_244, ptr %eraser_pointer_271, align 8, !noalias !0
  %tag_272 = extractvalue %Pos %v_r_2462_13_177_4109, 0
  switch i64 %tag_272, label %label_274 [
    i64 0, label %label_279
    i64 1, label %label_291
  ]

label_274:                                        ; preds = %stackAllocate.exit
  ret void
...
label_279:                                        ; preds = %stackAllocate.exit
  ...
  store ptr @sharer_240, ptr %sharer_pointer_270, align 8, !noalias !0
  store ptr @eraser_244, ptr %eraser_pointer_271, align 8, !noalias !0
  %utf8StringLiteral_4513.i = tail call %Pos @c_bytearray_construct(i64 0, ptr nonnull @utf8StringLiteral_4513.lit)
  ...
  %returnAddress_255.i = load ptr, ptr %newStackPointer.i18.i, align 8, !noalias !0
  musttail call tailcc void %returnAddress_255.i(%Pos %utf8StringLiteral_4513.i, ptr nonnull %stack)
  ret void

label_291:                                        ; preds = %stackAllocate.exit
  %fields_273 = extractvalue %Pos %v_r_2462_13_177_4109, 1
  %environment.i6 = getelementptr i8, ptr %fields_273, i64 16
  %v_y_2701_10_21_185_4024.unpack = load i64, ptr %environment.i6, align 8, !noalias !0
  %v_y_2701_10_21_185_4024.elt1 = getelementptr i8, ptr %fields_273, i64 24
  %v_y_2701_10_21_185_4024.unpack2 = load ptr, ptr %v_y_2701_10_21_185_4024.elt1, align 8, !noalias !0
  %isNull.i.i = icmp eq ptr %v_y_2701_10_21_185_4024.unpack2, null
  br i1 %isNull.i.i, label %next.i, label %next.i.i

next.i.i:                                         ; preds = %label_291
  %referenceCount.i.i = load i64, ptr %v_y_2701_10_21_185_4024.unpack2, align 4
  %referenceCount.1.i.i = add i64 %referenceCount.i.i, 1
  store i64 %referenceCount.1.i.i, ptr %v_y_2701_10_21_185_4024.unpack2, align 4
  br label %next.i

next.i:                                           ; preds = %next.i.i, %label_291
  %referenceCount.i = load i64, ptr %fields_273, align 4
  %cond.i = icmp eq i64 %referenceCount.i, 0
  br i1 %cond.i, label %free.i, label %decr.i

decr.i:                                           ; preds = %next.i
  %referenceCount.1.i = add i64 %referenceCount.i, -1
  store i64 %referenceCount.1.i, ptr %fields_273, align 4
  br label %eraseObject.exit

free.i:                                           ; preds = %next.i
  %objectEraser.i8 = getelementptr i8, ptr %fields_273, i64 8
  %eraser.i = load ptr, ptr %objectEraser.i8, align 8
  tail call void %eraser.i(ptr nonnull %environment.i6)
  tail call void @free(ptr nonnull %fields_273)
  br label %eraseObject.exit
...
eraseObject.exit:                                 ; preds = %decr.i, %free.i
  ...
  store ptr @eraser_165, ptr %objectEraser.i, align 8
  %environment.i = getelementptr i8, ptr %object.i, i64 16
  store i64 %v_y_2701_10_21_185_4024.unpack, ptr %environment.i, align 8, !noalias !0
  %environment_284.repack4 = getelementptr i8, ptr %object.i, i64 24
  store ptr %v_y_2701_10_21_185_4024.unpack2, ptr %environment_284.repack4, align 8, !noalias !0
  %make_4515 = insertvalue %Pos { i64 1, ptr null }, ptr %object.i, 1
  ...
  %returnAddress_288 = load ptr, ptr %newStackPointer.i29, align 8, !noalias !0
  musttail call tailcc void %returnAddress_288(%Pos %make_4515, ptr nonnull %stack)
  ret void
}
...
stackAllocate.exit:                               ; preds = %entry, %realloc.i
  ...
  store ptr %nextStackPointer.sink.i, ptr %stackPointer_pointer.i, align 8
  %sharer_pointer_11 = getelementptr i8, ptr %common.ret.op.i, i64 8
  %eraser_pointer_12 = getelementptr i8, ptr %common.ret.op.i, i64 16
  store ptr @returnAddress_1, ptr %common.ret.op.i, align 8, !noalias !0
  store ptr @sharer_5, ptr %sharer_pointer_11, align 8, !noalias !0
  store ptr @eraser_7, ptr %eraser_pointer_12, align 8, !noalias !0
  %calloc.i.i = tail call noalias noundef dereferenceable_or_null(16) ptr @calloc(i64 1, i64 16)
  %stack.i = tail call dereferenceable_or_null(48) ptr @malloc(i64 48)
  %stackPointer.i.i = tail call dereferenceable_or_null(64) ptr @malloc(i64 64)
  %limit.i.i = getelementptr i8, ptr %stackPointer.i.i, i64 64
...
stackAllocate.exit23:                             ; preds = %stackAllocate.exit, %realloc.i9
  ...
  %sharer_pointer_25 = getelementptr i8, ptr %common.ret.op.i8, i64 8
  %eraser_pointer_26 = getelementptr i8, ptr %common.ret.op.i8, i64 16
  store ptr @returnAddress_14, ptr %common.ret.op.i8, align 8, !noalias !0
  store ptr @sharer_19, ptr %sharer_pointer_25, align 8, !noalias !0
  store ptr @eraser_21, ptr %eraser_pointer_26, align 8, !noalias !0
...
stackAllocate.exit46:                             ; preds = %stackAllocate.exit23, %realloc.i32
  ...
  %returnAddress_pointer_296 = getelementptr i8, ptr %common.ret.op.i31, i64 8
  %sharer_pointer_297 = getelementptr i8, ptr %common.ret.op.i31, i64 16
  %eraser_pointer_298 = getelementptr i8, ptr %common.ret.op.i31, i64 24
  store ptr @returnAddress_46, ptr %returnAddress_pointer_296, align 8, !noalias !0
  store ptr @sharer_240, ptr %sharer_pointer_297, align 8, !noalias !0
  store ptr @eraser_244, ptr %eraser_pointer_298, align 8, !noalias !0
  %z.i6.i = icmp slt i64 %z.i, 1
  br i1 %z.i6.i, label %label_44.i, label %label_40.i

label_40.i:                                       ; preds = %stackAllocate.exit46, %label_40.i
  %acc_3_3_5_169_4278.tr8.i = phi %Pos [ %make_4468.i, %label_40.i ], [ zeroinitializer, %stackAllocate.exit46 ]
  %start_2_2_4_168_4096.tr7.i = phi i64 [ %z.i5.i, %label_40.i ], [ %z.i, %stackAllocate.exit46 ]
  %s.i.i = tail call %Pos @c_get_arg(i64 %start_2_2_4_168_4096.tr7.i)
  %z.i5.i = add nsw i64 %start_2_2_4_168_4096.tr7.i, -1
  ...
  store ptr @eraser_34, ptr %objectEraser.i.i, align 8
  %environment.i.i = getelementptr i8, ptr %object.i.i, i64 16
  %pureApp_4465.elt.i = extractvalue %Pos %s.i.i, 0
  store i64 %pureApp_4465.elt.i, ptr %environment.i.i, align 8, !noalias !0
  %environment_31.repack1.i = getelementptr i8, ptr %object.i.i, i64 24
  %pureApp_4465.elt2.i = extractvalue %Pos %s.i.i, 1
  store ptr %pureApp_4465.elt2.i, ptr %environment_31.repack1.i, align 8, !noalias !0
  %acc_3_3_5_169_4278_pointer_38.i = getelementptr i8, ptr %object.i.i, i64 32
  %acc_3_3_5_169_4278.elt.i = extractvalue %Pos %acc_3_3_5_169_4278.tr8.i, 0
  store i64 %acc_3_3_5_169_4278.elt.i, ptr %acc_3_3_5_169_4278_pointer_38.i, align 8, !noalias !0
  %acc_3_3_5_169_4278_pointer_38.repack3.i = getelementptr i8, ptr %object.i.i, i64 40
  %acc_3_3_5_169_4278.elt4.i = extractvalue %Pos %acc_3_3_5_169_4278.tr8.i, 1
  store ptr %acc_3_3_5_169_4278.elt4.i, ptr %acc_3_3_5_169_4278_pointer_38.repack3.i, align 8, !noalias !0
  %make_4468.i = insertvalue %Pos { i64 1, ptr null }, ptr %object.i.i, 1
  %z.i.i = icmp ult i64 %start_2_2_4_168_4096.tr7.i, 2
  br i1 %z.i.i, label %label_44.i.loopexit, label %label_40.i

label_44.i.loopexit:                              ; preds = %label_40.i
...
label_44.i:                                       ; preds = %label_44.i.loopexit, %stackAllocate.exit46
  %limit.i.i48 = phi ptr [ %limit.i.i4851, %stackAllocate.exit46 ], [ %limit.i.i48.pre, %label_44.i.loopexit ]
  %stackPointer.i.i47 = phi ptr [ %nextStackPointer.sink.i30, %stackAllocate.exit46 ], [ %stackPointer.i.i47.pre, %label_44.i.loopexit ]
  %acc_3_3_5_169_4278.tr.lcssa.i = phi %Pos [ zeroinitializer, %stackAllocate.exit46 ], [ %make_4468.i, %label_44.i.loopexit ]
  ...
  %returnAddress_41.i = load ptr, ptr %newStackPointer.i.i, align 8, !noalias !0
  musttail call tailcc void %returnAddress_41.i(%Pos %acc_3_3_5_169_4278.tr.lcssa.i, ptr nonnull %stack.i)
  ret void
}

define tailcc void @returnAddress_299(%Pos %v_r_2630_3422, ptr %stack) {
entry:
  %stackPointer_pointer.i = getelementptr i8, ptr %stack, i64 8
  %stackPointer.i = load ptr, ptr %stackPointer_pointer.i, align 8, !alias.scope !0
  %oldStackPointer.i = getelementptr i8, ptr %stackPointer.i, i64 24
  ...
  %index_2107_pointer_302 = getelementptr i8, ptr %stackPointer.i, i64 -24
  %index_2107 = load i64, ptr %index_2107_pointer_302, align 4, !noalias !0
...
eraseNegative.exit:                               ; preds = %label_310, %decr.i.i, %free.i.i
  ...
  %returnAddress_307 = load ptr, ptr %newStackPointer.i17, align 8, !noalias !0
  musttail call tailcc void %returnAddress_307(i64 %x.i, ptr nonnull %stack)
  ret void

label_316:                                        ; preds = %entry
  %Exception_2362_pointer_303 = getelementptr i8, ptr %stackPointer.i, i64 -16
  %Exception_2362.unpack = load ptr, ptr %Exception_2362_pointer_303, align 8, !noalias !0
  %z.i = tail call %Pos @c_bytearray_show_Int(i64 %index_2107)
  %utf8StringLiteral_4450 = tail call %Pos @c_bytearray_construct(i64 21, ptr nonnull @utf8StringLiteral_4450.lit)
  %spz.i = tail call %Pos @c_bytearray_concatenate(%Pos %utf8StringLiteral_4450, %Pos %z.i)
  %utf8StringLiteral_4452 = tail call %Pos @c_bytearray_construct(i64 13, ptr nonnull @utf8StringLiteral_4452.lit)
  %spz.i18 = tail call %Pos @c_bytearray_concatenate(%Pos %spz.i, %Pos %utf8StringLiteral_4452)
  %spz.i19 = tail call %Pos @c_bytearray_concatenate(%Pos %spz.i18, %Pos %str_21063)
  %utf8StringLiteral_4455 = tail call %Pos @c_bytearray_construct(i64 1, ptr nonnull @utf8StringLiteral_4455.lit)
  %spz.i20 = tail call %Pos @c_bytearray_concatenate(%Pos %spz.i19, %Pos %utf8StringLiteral_4455)
  %functionPointer_315 = load ptr, ptr %Exception_2362.unpack, align 8, !noalias !0
  musttail call tailcc void %functionPointer_315(ptr %Exception_2362.unpack5, %Pos zeroinitializer, %Pos %spz.i20, ptr nonnull %stack)
  ret void
}

define void @sharer_320(ptr %stackPointer) {
entry:
  %str_2106_317.elt1 = getelementptr i8, ptr %stackPointer, i64 -32
  %str_2106_317.unpack2 = load ptr, ptr %str_2106_317.elt1, align 8, !noalias !0
  %Exception_2362_319.elt4 = getelementptr i8, ptr %stackPointer, i64 -8
  %Exception_2362_319.unpack5 = load ptr, ptr %Exception_2362_319.elt4, align 8, !noalias !0
  %isNull.i.i = icmp eq ptr %str_2106_317.unpack2, null
  br i1 %isNull.i.i, label %sharePositive.exit, label %next.i.i

next.i.i:                                         ; preds = %entry
  %referenceCount.i.i = load i64, ptr %str_2106_317.unpack2, align 4
  %referenceCount.1.i.i = add i64 %referenceCount.i.i, 1
  store i64 %referenceCount.1.i.i, ptr %str_2106_317.unpack2, align 4
  br label %sharePositive.exit

sharePositive.exit:                               ; preds = %entry, %next.i.i
  %isNull.i.i7 = icmp eq ptr %Exception_2362_319.unpack5, null
  br i1 %isNull.i.i7, label %shareNegative.exit, label %next.i.i8

next.i.i8:                                        ; preds = %sharePositive.exit
  %referenceCount.i.i9 = load i64, ptr %Exception_2362_319.unpack5, align 4
  %referenceCount.1.i.i10 = add i64 %referenceCount.i.i9, 1
  store i64 %referenceCount.1.i.i10, ptr %Exception_2362_319.unpack5, align 4
...
define void @eraser_328(ptr %stackPointer) {
entry:
  %str_2106_325.elt1 = getelementptr i8, ptr %stackPointer, i64 -32
  %str_2106_325.unpack2 = load ptr, ptr %str_2106_325.elt1, align 8, !noalias !0
  %Exception_2362_327.elt4 = getelementptr i8, ptr %stackPointer, i64 -8
  %Exception_2362_327.unpack5 = load ptr, ptr %Exception_2362_327.elt4, align 8, !noalias !0
  %isNull.i.i = icmp eq ptr %str_2106_325.unpack2, null
  br i1 %isNull.i.i, label %erasePositive.exit, label %next.i.i

next.i.i:                                         ; preds = %entry
  %referenceCount.i.i = load i64, ptr %str_2106_325.unpack2, align 4
  %cond.i.i = icmp eq i64 %referenceCount.i.i, 0
  br i1 %cond.i.i, label %free.i.i, label %decr.i.i

decr.i.i:                                         ; preds = %next.i.i
  %referenceCount.1.i.i = add i64 %referenceCount.i.i, -1
  store i64 %referenceCount.1.i.i, ptr %str_2106_325.unpack2, align 4
  br label %erasePositive.exit

free.i.i:                                         ; preds = %next.i.i
  %objectEraser.i.i = getelementptr i8, ptr %str_2106_325.unpack2, i64 8
  %eraser.i.i = load ptr, ptr %objectEraser.i.i, align 8
  %environment.i.i.i = getelementptr i8, ptr %str_2106_325.unpack2, i64 16
  tail call void %eraser.i.i(ptr %environment.i.i.i)
  tail call void @free(ptr nonnull %str_2106_325.unpack2)
  br label %erasePositive.exit

erasePositive.exit:                               ; preds = %entry, %decr.i.i, %free.i.i
  %isNull.i.i7 = icmp eq ptr %Exception_2362_327.unpack5, null
  br i1 %isNull.i.i7, label %eraseNegative.exit, label %next.i.i8

next.i.i8:                                        ; preds = %erasePositive.exit
  %referenceCount.i.i9 = load i64, ptr %Exception_2362_327.unpack5, align 4
  %cond.i.i10 = icmp eq i64 %referenceCount.i.i9, 0
  br i1 %cond.i.i10, label %free.i.i13, label %decr.i.i11

decr.i.i11:                                       ; preds = %next.i.i8
  %referenceCount.1.i.i12 = add i64 %referenceCount.i.i9, -1
  store i64 %referenceCount.1.i.i12, ptr %Exception_2362_327.unpack5, align 4
  br label %eraseNegative.exit

free.i.i13:                                       ; preds = %next.i.i8
  %objectEraser.i.i14 = getelementptr i8, ptr %Exception_2362_327.unpack5, i64 8
  %eraser.i.i15 = load ptr, ptr %objectEraser.i.i14, align 8
  %environment.i.i.i16 = getelementptr i8, ptr %Exception_2362_327.unpack5, i64 16
  tail call void %eraser.i.i15(ptr %environment.i.i.i16)
  tail call void @free(ptr nonnull %Exception_2362_327.unpack5)
  br label %eraseNegative.exit
...
stackAllocate.exit:                               ; preds = %sharePositive.exit, %realloc.i
  ...
  %stackPointer_333.repack1 = getelementptr inbounds i8, ptr %common.ret.op.i, i64 8
  store ptr %object.i, ptr %stackPointer_333.repack1, align 8, !noalias !0
  %index_2107_pointer_335 = getelementptr i8, ptr %common.ret.op.i, i64 16
  store i64 %index_2107, ptr %index_2107_pointer_335, align 4, !noalias !0
  %Exception_2362_pointer_336 = getelementptr i8, ptr %common.ret.op.i, i64 24
  %Exception_2362.elt = extractvalue %Neg %Exception_2362, 0
  store ptr %Exception_2362.elt, ptr %Exception_2362_pointer_336, align 8, !noalias !0
  %Exception_2362_pointer_336.repack3 = getelementptr i8, ptr %common.ret.op.i, i64 32
  %Exception_2362.elt4 = extractvalue %Neg %Exception_2362, 1
  store ptr %Exception_2362.elt4, ptr %Exception_2362_pointer_336.repack3, align 8, !noalias !0
  %returnAddress_pointer_337 = getelementptr i8, ptr %common.ret.op.i, i64 40
  %sharer_pointer_338 = getelementptr i8, ptr %common.ret.op.i, i64 48
  %eraser_pointer_339 = getelementptr i8, ptr %common.ret.op.i, i64 56
  store ptr @returnAddress_299, ptr %returnAddress_pointer_337, align 8, !noalias !0
  store ptr @sharer_320, ptr %sharer_pointer_338, align 8, !noalias !0
  store ptr @eraser_328, ptr %eraser_pointer_339, align 8, !noalias !0
  %switch.not.not = icmp sgt i64 %index_2107, -1
  br i1 %switch.not.not, label %label_346, label %label_351

label_346:                                        ; preds = %stackAllocate.exit
  ...
  %returnAddress_343 = load ptr, ptr %newStackPointer.i16, align 8, !noalias !0
  musttail call tailcc void %returnAddress_343(%Pos %adt_boolean.i12, ptr nonnull %stack)
  ret void

label_351:                                        ; preds = %stackAllocate.exit
  br i1 %isNull.i.i, label %erasePositive.exit, label %next.i.i7

next.i.i7:                                        ; preds = %label_351
...
erasePositive.exit:                               ; preds = %label_351, %decr.i.i, %free.i.i
  ...
  %returnAddress_348 = load ptr, ptr %newStackPointer.i22, align 8, !noalias !0
  musttail call tailcc void %returnAddress_348(%Pos { i64 1, ptr null }, ptr nonnull %stack)
  ret void
}
