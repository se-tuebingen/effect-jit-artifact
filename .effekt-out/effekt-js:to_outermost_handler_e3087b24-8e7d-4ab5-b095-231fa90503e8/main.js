...
class OutOfBounds_0 {
  ...
  __equals(other4750) {
    ...
    if (!($effekt.equals(this.__tag, other4750.__tag))) {
      return false;
    }
    return true;
  }
...
class WrongFormat_0 {
  ...
  __equals(other4751) {
    ...
    if (!($effekt.equals(this.__tag, other4751.__tag))) {
      return false;
    }
    return true;
  }
...
class None_0 {
  ...
  __equals(other4752) {
    ...
    if (!($effekt.equals(this.__tag, other4752.__tag))) {
      return false;
    }
    return true;
  }
...
class Some_0 {
  ...
  __equals(other4753) {
    ...
    if (!($effekt.equals(this.__tag, other4753.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.value_0, other4753.value_0))) {
      return false;
    }
    return true;
  }
...
class Nil_0 {
  ...
  __equals(other4754) {
    ...
    if (!($effekt.equals(this.__tag, other4754.__tag))) {
      return false;
    }
    return true;
  }
...
class Cons_0 {
  ...
  __equals(other4755) {
    ...
    if (!($effekt.equals(this.__tag, other4755.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.head_0, other4755.head_0))) {
      return false;
    }
    if (!($effekt.equals(this.tail_0, other4755.tail_0))) {
      return false;
    }
    return true;
  }
...
class Error_0 {
  ...
  __equals(other4756) {
    ...
    if (!($effekt.equals(this.__tag, other4756.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.exception_0, other4756.exception_0))) {
      return false;
    }
    if (!($effekt.equals(this.msg_0, other4756.msg_0))) {
      return false;
    }
    return true;
  }
...
class Success_0 {
  ...
  __equals(other4757) {
    ...
    if (!($effekt.equals(this.__tag, other4757.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.a_0, other4757.a_0))) {
      return false;
    }
    return true;
  }
...
function main_0(ks_18, k_27) {
  return RESET((p_2, ks_13, k_11) => {
    ...
    RESET((p_3, ks_20, k_16) => {
      ...
      const v_0 = ks_29.arena.fresh(n_0);
      function pad_worker_0(d_1, ks_31, k_26) {
        pad_worker_1: while (true) {
          if (d_1 === (0)) {
            ...
            const v_1 = ks_31.arena.fresh(-377);
            /* prepare call */
            const tmp_d_0 = d_1;
            const tmp_k_0 = k_26;
            k_26 = (tmp_6, ks_32) => {
              DEALLOC(v_1);
              return () => tmp_k_0(tmp_6, ks_32);
            };
            d_1 = (tmp_d_0 - (1));
            continue pad_worker_1;
          }
        }
      }
      return pad_worker_0(d_0, ks_29, (tmp_7, ks_33) => {
        DEALLOC(v_0);
        const tmp_8 = $effekt.println(('' + tmp_7));
        return () => k_27(tmp_8, ks_33);
      });
    }));
}
