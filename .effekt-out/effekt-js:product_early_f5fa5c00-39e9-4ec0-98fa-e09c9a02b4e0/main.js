...
class OutOfBounds_0 {
  ...
  __equals(other4588) {
    ...
    if (!($effekt.equals(this.__tag, other4588.__tag))) {
      return false;
    }
    return true;
  }
...
class None_0 {
  ...
  __equals(other4589) {
    ...
    if (!($effekt.equals(this.__tag, other4589.__tag))) {
      return false;
    }
    return true;
  }
...
class Some_0 {
  ...
  __equals(other4590) {
    ...
    if (!($effekt.equals(this.__tag, other4590.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.value_0, other4590.value_0))) {
      return false;
    }
    return true;
  }
...
class Nil_0 {
  ...
  __equals(other4591) {
    ...
    if (!($effekt.equals(this.__tag, other4591.__tag))) {
      return false;
    }
    return true;
  }
...
class Cons_0 {
  ...
  __equals(other4592) {
    ...
    if (!($effekt.equals(this.__tag, other4592.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.head_0, other4592.head_0))) {
      return false;
    }
    if (!($effekt.equals(this.tail_0, other4592.tail_0))) {
      return false;
    }
    return true;
  }
...
class Error_0 {
  ...
  __equals(other4593) {
    ...
    if (!($effekt.equals(this.__tag, other4593.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.exception_0, other4593.exception_0))) {
      return false;
    }
    if (!($effekt.equals(this.msg_0, other4593.msg_0))) {
      return false;
    }
    return true;
  }
...
class Success_0 {
  ...
  __equals(other4594) {
    ...
    if (!($effekt.equals(this.__tag, other4594.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.a_0, other4594.a_0))) {
      return false;
    }
    return true;
  }
...
function enumerate_0(i_0, ks_1, k_1) {
  enumerate_1: while (true) {
    if ((i_0 < (0))) {
      return () => k_1(new Nil_0(), ks_1);
    } else {
      /* prepare call */
      const tmp_i_0 = i_0;
      const tmp_k_0 = k_1;
      k_1 = (v_r_1, ks_2) =>
        () => tmp_k_0(new Cons_0(tmp_i_0, v_r_1), ks_2);
      i_0 = (tmp_i_0 - (1));
      continue enumerate_1;
    }
  }
}

function main_0(ks_18, k_21) {
  return RESET((p_0, ks_3, k_2) => {
    ...
    return toList_worker_0((tmp_1 - (1)), new Nil_0(), ks_3, (v_r_2, ks_5) => {
      let v_r_3 = undefined;
      switch (v_r_2.__tag) {
      ...
      function go_0(index_1, acc_1, ks_10, k_8) {
        return RESET((p_1, ks_6, k_4) => {
          ...
          return charAt_0(v_r_4, index_1, Exception_1, ks_6, (v_r_5, ks_9) =>
            () => k_4(new Success_0(v_r_5), ks_9));
        }, ks_10, (v_r_6, ks_11) => {
          switch (v_r_6.__tag) {
            case 1: 
              ...
              if ((v_y_2 >= (48))) if ((v_y_2 <= (57))) {
                ...
                return SHIFT(p_0, (k_9, ks_12, k_10) =>
                  () => k_10(5, ks_12), ks_11, undefined);
              } else {
                return SHIFT(p_0, (k_11, ks_13, k_12) =>
                  () => k_12(5, ks_13), ks_11, undefined);
              }
              break;
      ...
      const Exception_2 = {
        raise_0: (exception_1, msg_2, ks_14, k_13) =>
          SHIFT(p_0, (k_14, ks_15, k_15) => () => k_15(5, ks_15), ks_14, undefined)
      };
      return charAt_0(v_r_4, 0, Exception_2, ks_5, (v_r_7, ks_16) => {
        if (v_r_7 === (45)) {
          return go_0(1, 0, ks_16, (v_r_8, ks_17) =>
            () => k_2(((0) - v_r_8), ks_17));
        } else {
    ...
    enumerate_0(1000, ks_19, (xs_0, ks_20) => {
      function loop_0(i_1, a_1, ks_21, k_16) {
        if (i_1 === (0)) {
          return () => k_16(a_1, ks_21);
        } else {
          return RESET((p_2, ks_22, k_17) => {
            function product_worker_0(xs_1, ks_23, k_18) {
              product_worker_1: while (true) {
                switch (xs_1.__tag) {
                  case 0:  return () => k_18(0, ks_23);
                  case 1: 
                    const v_y_3 = xs_1.head_0;
                    const v_y_4 = xs_1.tail_0;
                    if (v_y_3 === (0)) {
                      return SHIFT(p_2, (k_19, ks_24, k_20) =>
                        () => k_20(0, ks_24), ks_23, k_18);
                    } else {
                      /* prepare call */
                      const tmp_k_1 = k_18;
                      k_18 = (v_r_9, ks_25) =>
                        () => tmp_k_1((v_y_3 * v_r_9), ks_25);
                      xs_1 = v_y_4;
                      continue product_worker_1;
                    }
                    break;
                }
              }
            }
            return product_worker_0(xs_0, ks_22, k_17);
          }, ks_21, (v_r_10, ks_26) =>
            loop_0((i_1 - (1)), (a_1 + v_r_10), ks_26, k_16));
        }
      }
      return loop_0(n_0, 0, ks_20, (r_0, ks_27) => {
        const tmp_3 = $effekt.println(('' + r_0));
        return () => k_21(tmp_3, ks_27);
      });
    }));
}
