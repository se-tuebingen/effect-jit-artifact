...
class OutOfBounds_0 {
  ...
  __equals(other4543) {
    ...
    if (!($effekt.equals(this.__tag, other4543.__tag))) {
      return false;
    }
    return true;
  }
...
class None_0 {
  ...
  __equals(other4544) {
    ...
    if (!($effekt.equals(this.__tag, other4544.__tag))) {
      return false;
    }
    return true;
  }
...
class Some_0 {
  ...
  __equals(other4545) {
    ...
    if (!($effekt.equals(this.__tag, other4545.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.value_0, other4545.value_0))) {
      return false;
    }
    return true;
  }
...
class Nil_0 {
  ...
  __equals(other4546) {
    ...
    if (!($effekt.equals(this.__tag, other4546.__tag))) {
      return false;
    }
    return true;
  }
...
class Cons_0 {
  ...
  __equals(other4547) {
    ...
    if (!($effekt.equals(this.__tag, other4547.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.head_0, other4547.head_0))) {
      return false;
    }
    if (!($effekt.equals(this.tail_0, other4547.tail_0))) {
      return false;
    }
    return true;
  }
...
class Error_0 {
  ...
  __equals(other4548) {
    ...
    if (!($effekt.equals(this.__tag, other4548.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.exception_0, other4548.exception_0))) {
      return false;
    }
    if (!($effekt.equals(this.msg_0, other4548.msg_0))) {
      return false;
    }
    return true;
  }
...
class Success_0 {
  ...
  __equals(other4549) {
    ...
    if (!($effekt.equals(this.__tag, other4549.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.a_0, other4549.a_0))) {
      return false;
    }
    return true;
  }
...
function main_0(ks_16, k_18) {
  return RESET((p_0, ks_1, k_1) => {
    ...
    const Prime_0 = {
      Prime_1: (e_0, ks_18, k_15) => () => k_15(true, ks_18)
    };
    function primes_worker_0(i_0, a_1, Prime_3, ks_19, k_16) {
      if ((i_0 >= n_0)) {
        return () => k_16(a_1, ks_19);
      } else {
        return Prime_3.Prime_1(i_0, ks_19, (v_r_8, ks_20) => {
          if (v_r_8) {
            const Prime_2 = {
              Prime_1: (e_1, ks_21, k_17) => {
                if (((e_1 % i_0)) === (0)) {
                  return () => k_17(false, ks_21);
                } else {
                  return Prime_3.Prime_1(e_1, ks_21, k_17);
                }
              }
            };
            return primes_worker_0((i_0 + (1)), (a_1 + i_0), Prime_2, ks_20, k_16);
          } else {
            return primes_worker_0((i_0 + (1)), a_1, Prime_3, ks_20, k_16);
          }
        });
      }
    }
    return primes_worker_0(2, 0, Prime_0, ks_17, (r_0, ks_22) => {
      const tmp_3 = $effekt.println(('' + r_0));
      return () => k_18(tmp_3, ks_22);
    });
  });
}
