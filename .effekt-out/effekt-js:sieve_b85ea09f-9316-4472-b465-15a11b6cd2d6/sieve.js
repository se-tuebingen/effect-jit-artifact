...
class OutOfBounds_0 {
  ...
  __equals(other4639) {
    ...
    if (!($effekt.equals(this.__tag, other4639.__tag))) {
      return false;
    }
    return true;
  }
...
class None_0 {
  ...
  __equals(other4640) {
    ...
    if (!($effekt.equals(this.__tag, other4640.__tag))) {
      return false;
    }
    return true;
  }
...
class Some_0 {
  ...
  __equals(other4641) {
    ...
    if (!($effekt.equals(this.__tag, other4641.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.value_0, other4641.value_0))) {
      return false;
    }
    return true;
  }
...
class Nil_0 {
  ...
  __equals(other4642) {
    ...
    if (!($effekt.equals(this.__tag, other4642.__tag))) {
      return false;
    }
    return true;
  }
...
class Cons_0 {
  ...
  __equals(other4643) {
    ...
    if (!($effekt.equals(this.__tag, other4643.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.head_0, other4643.head_0))) {
      return false;
    }
    if (!($effekt.equals(this.tail_0, other4643.tail_0))) {
      return false;
    }
    return true;
  }
...
class Error_0 {
  ...
  __equals(other4644) {
    ...
    if (!($effekt.equals(this.__tag, other4644.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.exception_0, other4644.exception_0))) {
      return false;
    }
    if (!($effekt.equals(this.msg_0, other4644.msg_0))) {
      return false;
    }
    return true;
  }
...
class Success_0 {
  ...
  __equals(other4645) {
    ...
    if (!($effekt.equals(this.__tag, other4645.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.a_0, other4645.a_0))) {
      return false;
    }
    return true;
  }
...
function run_0(size_0, ks_1, k_6) {
  const primeCount_0 = ks_1.arena.fresh(0);
  const tmp_0 = (new Array(size_0));
  ...
  return loop_0(0, ks_1, (v_r_1, ks_3) => {
    function loop_2(i_1, ks_5, k_3) {
      if ((i_1 < size_0)) {
        const tmp_2 = tmp_0[((i_1 - (1)))];
        function k_2(_0, ks_4) {
          return loop_2((i_1 + (1)), ks_4, k_3);
        }
        if (tmp_2) {
          const x_0 = primeCount_0.value;
          primeCount_0.value = (x_0 + (1));
          const k_4 = ks_5.arena.fresh((i_1 + i_1));
          function b_whileLoop_0(ks_6, k_5) {
            b_whileLoop_1: while (true) {
              const x_1 = k_4.value;
              if ((x_1 <= size_0)) {
                const x_2 = k_4.value;
                const tmp_3 = array$set(tmp_0, ((x_2 - (1))), (false));
                const x_3 = k_4.value;
                k_4.value = (x_3 + i_1);
                /* prepare call */
                continue b_whileLoop_1;
              } else {
                return () => k_5($effekt.unit, ks_6);
              }
            }
          }
          return b_whileLoop_0(ks_5, (tmp_4, ks_7) => {
            DEALLOC(k_4);
            return () => k_2(tmp_4, ks_7);
          });
        } else {
          return () => k_2($effekt.unit, ks_5);
        }
      } else {
        return () => k_3($effekt.unit, ks_5);
      }
    }
    return loop_2(2, ks_3, (_1, ks_8) => {
      const x_4 = primeCount_0.value;
      DEALLOC(primeCount_0);
      return () => k_6(x_4, ks_8);
    });
  });
}

function main_0(ks_24, k_22) {
  return RESET((p_0, ks_9, k_7) => {
    const tmp_5 = process.argv.slice(1);
    const tmp_6 = tmp_5.length;
    function toList_worker_0(start_0, acc_0, ks_10, k_8) {
      toList_worker_1: while (true) {
        if ((start_0 < (1))) {
          return () => k_8(acc_0, ks_10);
        } else {
          const tmp_7 = tmp_5[start_0];
          /* prepare call */
          const tmp_start_0 = start_0;
          const tmp_acc_0 = acc_0;
          start_0 = (tmp_start_0 - (1));
          acc_0 = new Cons_0(tmp_7, tmp_acc_0);
          continue toList_worker_1;
        }
      }
    }
    return toList_worker_0((tmp_6 - (1)), new Nil_0(), ks_9, (v_r_2, ks_11) => {
      let v_r_3 = undefined;
      switch (v_r_2.__tag) {
        case 0:  v_r_3 = new None_0();break;
        case 1: 
          const v_y_0 = v_r_2.head_0;
          v_r_3 = new Some_0(v_y_0);
          break;
      }
      let v_r_4 = undefined;
      switch (v_r_3.__tag) {
        case 0:  v_r_4 = "";break;
        case 1:  const v_y_1 = v_r_3.value_0;v_r_4 = v_y_1;break;
      }
      function go_0(index_1, acc_1, ks_16, k_13) {
        return RESET((p_1, ks_12, k_9) => {
          const Exception_1 = {
            raise_0: (exc_0, msg_1, ks_13, k_10) =>
              SHIFT(p_1, (k_11, ks_14, k_12) =>
                () => k_12(new Error_0(exc_0, msg_1), ks_14), ks_13, undefined)
          };
          return charAt_0(v_r_4, index_1, Exception_1, ks_12, (v_r_5, ks_15) =>
            () => k_9(new Success_0(v_r_5), ks_15));
        }, ks_16, (v_r_6, ks_17) => {
          switch (v_r_6.__tag) {
            case 1: 
              const v_y_2 = v_r_6.a_0;
              if ((v_y_2 >= (48))) if ((v_y_2 <= (57))) {
                return go_0((index_1 + (1)), ((((10) * acc_1)) + (((v_y_2) - ((48))))), ks_17, k_13);
              } else {
                return SHIFT(p_0, (k_14, ks_18, k_15) =>
                  () => k_15(10, ks_18), ks_17, undefined);
              } else {
                return SHIFT(p_0, (k_16, ks_19, k_17) =>
                  () => k_17(10, ks_19), ks_17, undefined);
              }
              break;
            case 0:  return () => k_13(acc_1, ks_17);
          }
        });
      }
      const Exception_2 = {
        raise_0: (exception_1, msg_2, ks_20, k_18) =>
          SHIFT(p_0, (k_19, ks_21, k_20) => () => k_20(10, ks_21), ks_20, undefined)
      };
      return charAt_0(v_r_4, 0, Exception_2, ks_11, (v_r_7, ks_22) => {
        if (v_r_7 === (45)) {
          return go_0(1, 0, ks_22, (v_r_8, ks_23) =>
            () => k_7(((0) - v_r_8), ks_23));
        } else {
          return go_0(0, 0, ks_22, k_7);
        }
      });
    });
  }, ks_24, (n_0, ks_25) => {
    function loop_3(i_2, ks_26, k_21) {
      if ((i_2 < ((n_0 - (1))))) {
        return run_0(5000, ks_26, (v_r_9, ks_27) =>
          loop_3((i_2 + (1)), ks_27, k_21));
      } else {
        return () => k_21($effekt.unit, ks_26);
      }
    }
    return loop_3(0, ks_25, (v_r_10, ks_28) =>
      run_0(5000, ks_28, (r_0, ks_29) => {
        const tmp_8 = $effekt.println(('' + r_0));
        return () => k_22(tmp_8, ks_29);
      }));
  });
}

(typeof module != "undefined" && module !== null ? module : {}).exports = $sieve = {
