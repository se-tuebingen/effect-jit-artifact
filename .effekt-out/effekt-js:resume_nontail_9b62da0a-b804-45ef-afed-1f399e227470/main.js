...
class None_0 {
  ...
  __equals(other4595) {
    ...
    if (!($effekt.equals(this.__tag, other4595.__tag))) {
      return false;
    }
    return true;
  }
...
class Some_0 {
  ...
  __equals(other4596) {
    ...
    if (!($effekt.equals(this.__tag, other4596.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.value_0, other4596.value_0))) {
      return false;
    }
    return true;
  }
...
class Nil_0 {
  ...
  __equals(other4597) {
    ...
    if (!($effekt.equals(this.__tag, other4597.__tag))) {
      return false;
    }
    return true;
  }
...
class Cons_0 {
  ...
  __equals(other4598) {
    ...
    if (!($effekt.equals(this.__tag, other4598.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.head_0, other4598.head_0))) {
      return false;
    }
    if (!($effekt.equals(this.tail_0, other4598.tail_0))) {
      return false;
    }
    return true;
  }
...
class Error_0 {
  ...
  __equals(other4599) {
    ...
    if (!($effekt.equals(this.__tag, other4599.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.exception_0, other4599.exception_0))) {
      return false;
    }
    if (!($effekt.equals(this.msg_0, other4599.msg_0))) {
      return false;
    }
    return true;
  }
...
class Success_0 {
  ...
  __equals(other4600) {
    ...
    if (!($effekt.equals(this.__tag, other4600.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.a_0, other4600.a_0))) {
      return false;
    }
    return true;
  }
...
function main_0(ks_16, k_21) {
  return RESET((p_0, ks_1, k_1) => {
    ...
    function step_0(l_0, s_0, ks_18, k_15) {
      if (l_0 === (0)) {
        return () => k_15(s_0, ks_18);
      } else {
        return RESET((p_2, ks_19, k_16) => {
          function loop_worker_0(i_0, ks_20, k_17) {
            if (i_0 === (0)) {
              return () => k_17(s_0, ks_20);
            } else {
              return SHIFT(p_2, (k_18, ks_21, k_19) =>
                RESUME(k_18, (ks_22, k_20) =>
                  () => k_20($effekt.unit, ks_22), ks_21, (y_0, ks_23) => {
                  const tmp_3 = (((i_0 - (((503) * y_0)))) + (37));
                  if ((tmp_3 < (0))) {
                    return () => k_19(((((0) - tmp_3)) % (1009)), ks_23);
                  } else {
                    return () => k_19((tmp_3 % (1009)), ks_23);
                  }
                }), ks_20, (_0, ks_24) =>
                loop_worker_0((i_0 - (1)), ks_24, k_17));
            }
          }
          return loop_worker_0(n_0, ks_19, k_16);
        }, ks_18, (v_r_8, ks_25) => step_0((l_0 - (1)), v_r_8, ks_25, k_15));
      }
    }
    return step_0(1000, 0, ks_17, (r_0, ks_26) => {
      const tmp_4 = $effekt.println(('' + r_0));
      return () => k_21(tmp_4, ks_26);
    });
  });
}
