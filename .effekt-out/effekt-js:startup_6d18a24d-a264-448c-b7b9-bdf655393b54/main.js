...
class OutOfBounds_0 {
  ...
  __equals(other4397) {
    ...
    if (!($effekt.equals(this.__tag, other4397.__tag))) {
      return false;
    }
    return true;
  }
...
class None_0 {
  ...
  __equals(other4398) {
    ...
    if (!($effekt.equals(this.__tag, other4398.__tag))) {
      return false;
    }
    return true;
  }
...
class Some_0 {
  ...
  __equals(other4399) {
    ...
    if (!($effekt.equals(this.__tag, other4399.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.value_0, other4399.value_0))) {
      return false;
    }
    return true;
  }
...
class Nil_0 {
  ...
  __equals(other4400) {
    ...
    if (!($effekt.equals(this.__tag, other4400.__tag))) {
      return false;
    }
    return true;
  }
...
class Cons_0 {
  ...
  __equals(other4401) {
    ...
    if (!($effekt.equals(this.__tag, other4401.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.head_0, other4401.head_0))) {
      return false;
    }
    if (!($effekt.equals(this.tail_0, other4401.tail_0))) {
      return false;
    }
    return true;
  }
...
class Error_0 {
  ...
  __equals(other4402) {
    ...
    if (!($effekt.equals(this.__tag, other4402.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.exception_0, other4402.exception_0))) {
      return false;
    }
    if (!($effekt.equals(this.msg_0, other4402.msg_0))) {
      return false;
    }
    return true;
  }
...
class Success_0 {
  ...
  __equals(other4403) {
    ...
    if (!($effekt.equals(this.__tag, other4403.__tag))) {
      return false;
    }
    if (!($effekt.equals(this.a_0, other4403.a_0))) {
      return false;
    }
    return true;
  }
...
function main_0(ks_16, k_15) {
  return RESET((p_0, ks_1, k_1) => {
    ...
    const tmp_3 = $effekt.println(('' + (0)));
    return () => k_15(tmp_3, ks_17);
  });
}
